...
function unilib.pkg.metal_ozymandium.exec()
    ...
    unilib.set_compressed_metal_recipes("ozymandium")
    unilib.register_stairs("unilib:metal_ozymandium_block_compressed")
    ...
    unilib.set_auto_rotate("unilib:metal_ozymandium_brick", unilib.auto_rotate_brick_flag)
