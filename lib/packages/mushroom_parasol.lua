...
function unilib.pkg.mushroom_parasol.exec()
    ...
    unilib.register_node("unilib:mushroom_parasol", "nsspf:macrolepiota_procera", mode, {
        ...
        description = unilib.utils.annotate(S("Parasol Mushroom"), "Macrolepiota procera"),
        ...
        on_use = unilib.cuisine.eat_on_use("unilib:mushroom_parasol", 3),
    })
    ...
    unilib.register_node(
        ...
        mode,
        {
            ...
            on_use = unilib.cuisine.eat_on_use("unilib:mushroom_parasol_cooked", 16),
        }
    )
    ...
    unilib.register_decoration_generic("nsspf_mushroom_parasol", {
