...
function unilib.pkg.deco_farlands_flower_waterlily_exotic_pink.init()

    return {
        description = "Exotic waterlily with pink flower as decoration",
        depends = {"dirt_ordinary", "flower_waterlily_exotic_pink"},
        at_least_one = {
