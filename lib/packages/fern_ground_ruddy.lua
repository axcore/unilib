...
function unilib.pkg.fern_ground_ruddy.exec()
    ...
    unilib.register_node("unilib:fern_ground_ruddy", "australia:fern", mode, {
        -- From australia:fern
        description = unilib.annotate(S("Ruddy Ground Fern"), "Hypolepis rugosula"),
...
--      drop = "unilib:fern_ground_ruddy",
    ...
    unilib.register_decoration("australia_fern_ground_ruddy_1", {
        -- From australia:fern
        deco_type = "simple",
    ...
    unilib.register_decoration("australia_fern_ground_ruddy_2", {
        -- From australia:fern
        deco_type = "simple",
        decoration = "unilib:fern_ground_ruddy",
