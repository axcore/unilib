...
function unilib.pkg.mushroom_brain.exec()
    ...
    unilib.register_node("unilib:mushroom_brain", "nsspf:gyromitra_esculenta", mode, {
        ...
        description = unilib.annotate(S("Brain Mushroom"), "Gyromitra esculenta"),
        ...
        on_use = unilib.cuisine_eat_on_use("unilib:mushroom_brain", -20),
    })
    ...
    unilib.register_node("unilib:mushroom_brain_cooked", "nsspf:cooked_gyromitra_esculenta", mode, {
        ...
        on_use = unilib.cuisine_eat_on_use("unilib:mushroom_brain_cooked", -16),
    })
    ...
    unilib.register_decoration("nsspf_mushroom_brain", {
