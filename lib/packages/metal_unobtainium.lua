...
function unilib.pkg.metal_unobtainium.exec()
    ...
    unilib.register_carvings("unilib:metal_unobtainium_block", {
        millwork_flag = true,
    })
    ...
    if unilib.setting.squeezed_metal_flag then
        ...
        unilib.misc.set_compressed_metal_recipes("unobtainium")
    ...
    unilib.utils.set_auto_rotate(
        "unilib:metal_unobtainium_brick", unilib.setting.auto_rotate_brick_flag
    )
