...
function unilib.pkg.metal_zirconium.exec()
    ...
    unilib.register_stairs("unilib:metal_zirconium_block")
    unilib.register_carvings("unilib:metal_zirconium_block", {
        millwork_flag = true,
    })

    if unilib.setting.squeezed_metal_flag then

        unilib.register_node("unilib:metal_zirconium_block_compressed", nil, mode, {
            -- Original to unilib
            description = S("Compressed Zirconium Block"),
            tiles = {"unilib_metal_zirconium_block_compressed.png"},
        ...
        unilib.misc.set_compressed_metal_recipes("zirconium")
