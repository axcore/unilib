...
unilib.pkg.deco_trunks_misc_twig_normal = {}
...
function unilib.pkg.deco_trunks_misc_twig_normal.init()
...
function unilib.pkg.deco_trunks_misc_twig_normal.post()
    ...
    if unilib.global.pkg_executed_table["dirt_ordinary"] ~= nil then
        ...
        unilib.register_decoration_complete("convert_misc_twig_normal_on_ground", nil, {
            ...
            -- Completes decoration in package "misc_twig_normal"
    ...
    if unilib.global.pkg_executed_table["liquid_water_ordinary"] ~= nil then
        ...
        unilib.register_decoration_complete("convert_misc_twig_normal_on_water", nil, {
            -- From trunks/generating.lua
            -- Completes decoration in package "misc_twig_normal"
