...
function unilib.pkg.mineral_chrysoprase.exec()
    ...
    if unilib.global.pkg_executed_table["machine_polishing"] ~= nil then
        ...
        unilib.register_craftitem("unilib:mineral_chrysoprase_gem", nil, mode, {
            -- Original to unilib
            description = S("Chrysoprase Gem"),
            inventory_image = "unilib_mineral_chrysoprase_gem.png",
        })
        unilib.register_craft({
            -- Original to unilib
            output = "unilib:mineral_chrysoprase_gem 9",
            recipe = {
                {"unilib:mineral_chrysoprase_block"},
            },
        })

        unilib.register_node("unilib:mineral_chrysoprase_block", nil, mode, {
            -- Original to unilib
            description = S("Chrysoprase Block"),
            tiles = {"unilib_mineral_chrysoprase_block.png"},
        ...
        unilib.register_craft_3x3({
            -- Original to unilib
            output = "unilib:mineral_chrysoprase_block",
            ingredient = "unilib:mineral_chrysoprase_gem",
        })
        unilib.register_stairs("unilib:mineral_chrysoprase_block")
        unilib.register_carvings("unilib:mineral_chrysoprase_block", {
            millwork_flag = true,
        })
