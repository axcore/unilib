...
function unilib.pkg.machine_chiselling.exec()
    ...
    unilib.register_node("unilib:machine_chiselling", "stripped_tree:chiseling_machine", mode, {
        ...
        -- N.B. Commented out parts of the original code which seem to have been for a delayed
        --      conversion, that was either removed or never implemented
        --[[
        ...
        on_metadata_inventory_put = function(pos)
            ...
            if full_name ~= "" then
                ...
                local stripped_flag = core.registered_nodes[stripped_name]
