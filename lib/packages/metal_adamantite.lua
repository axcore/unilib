...
function unilib.pkg.metal_adamantite.exec()
    ...
    unilib.register_carvings("unilib:metal_adamantite_block", {
        millwork_flag = true,
    })
    ...
    if unilib.setting.squeezed_metal_flag then
        ...
        unilib.misc.set_compressed_metal_recipes("adamantite")
    ...
    unilib.utils.set_auto_rotate(
        "unilib:metal_adamantite_brick", unilib.setting.auto_rotate_brick_flag
    )
