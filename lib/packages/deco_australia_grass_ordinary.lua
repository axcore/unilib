...
function unilib.pkg.deco_australia_grass_ordinary.post()
    ...
    if unilib.pkg_executed_table["biome_australia_great_dividing_range"] ~= nil and
            unilib.pkg_executed_table["dirt_ordinary"] ~= nil then
    ...
    if unilib.pkg_executed_table["biome_australia_tasmania"] ~= nil and
            unilib.pkg_executed_table["dirt_ordinary"] ~= nil then
    ...
    if unilib.pkg_executed_table["biome_australia_timor_sea"] ~= nil and
            unilib.pkg_executed_table["sand_ordinary"] ~= nil then
