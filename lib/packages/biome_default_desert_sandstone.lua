...
function unilib.pkg.biome_default_desert_sandstone.post()
    ...
    unilib.register_biome({
        ...
        description = unilib.brackets(S("Desert sandstone biome"), "default"),
        ...
        node_dungeon_stair = unilib.convert_stairs_simple("unilib:stone_sandstone_ordinary_block"),
        y_max = unilib.y_max,
        y_min = 4,
        heat_point = 60,
        humidity_point = 0,
    ...
    unilib.register_biome({
        ...
        description = unilib.brackets(S("Desert sandstone ocean biome"), "default"),
        node_top = "unilib:sand_ordinary",
        depth_top = 1,
        node_filler = "unilib:sand_ordinary",
        depth_filler = 3,
    ...
    unilib.register_biome({
        ...
        description = unilib.brackets(S("Desert sandstone deep ocean biome"), "default"),
        node_cave_liquid = {
