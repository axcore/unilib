...
function unilib.pkg.mushroom_king.exec()
    ...
    if unilib.global.pkg_executed_table["shared_cropocalypse_mushroom"] ~= nil and
            unilib.global.pkg_executed_table["stone_ordinary_with_gold"] ~= nil then
    ...
    unilib.register_node("unilib:mushroom_king", "cropocalypse:king_mushroom", mode, {
        ...
        on_use = unilib.cuisine.eat_on_use("unilib:mushroom_king", 4),
    })
    unilib.register_mushroom_in_pot("unilib:mushroom_king", "cropocalypse:king_mushroom")

    unilib.register_decoration_generic("cropocalypse_mushroom_king", {
