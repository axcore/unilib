...
function unilib.pkg.mushroom_chanterelle.exec()
    ...
    unilib.register_node("unilib:mushroom_chanterelle", "nsspf:cantharellus_cibarius", mode, {
        ...
        description = unilib.utils.annotate(S("Chanterelle Mushroom"), "Cantharellus cibarius"),
        ...
        on_use = unilib.cuisine.eat_on_use("unilib:mushroom_chanterelle", 1),
    })
    ...
    unilib.register_node(
        ...
        mode,
        {
            ...
            on_use = unilib.cuisine.eat_on_use("unilib:mushroom_chanterelle_cooked", 8),
        }
    )
    ...
    unilib.register_decoration_generic("nsspf_mushroom_chanterelle", {
