...
local inactive_msg = S("Propane Grill Pro inactive")
...
function get_grill_active_formspec(fuel_percent, item_percent)
    ...
    -- Was default.get_propane_grill_pro_active_formspec()
...
function get_grill_inactive_formspec()
    ...
    -- Was default.get_propane_grill_pro_inactive_formspec()
...
function unilib.pkg.machine_grill_propane_pro.init()
...
function unilib.pkg.machine_grill_propane_pro.exec()

    unilib.register_node("unilib:machine_grill_propane_pro", "bbq:propane_grill_pro", mode, {
        -- From bbq:propane_grill_pro
        description = S("Propane Grill Pro"),
        tiles = {
        ...
        on_timer = function(pos, elapsed)
            ...
            return unilib.pkg.shared_bbq_grill.grill_node_timer(
                pos, elapsed,
                "unilib:machine_grill_propane_pro", "unilib:machine_grill_propane_pro_active",
    ...
    unilib.register_craft({
        -- From bbq:propane_grill_pro
        output = "unilib:machine_grill_propane_pro",
        recipe = {
    ...
    unilib.register_node(
        -- From bbq:propane_grill_pro_active
        "unilib:machine_grill_propane_pro_active",
        ...
        mode,
        {
            ...
            allow_metadata_inventory_take =
                    unilib.pkg.shared_bbq_grill.allow_metadata_inventory_take,
