...
function unilib.pkg.tree_wirewood.exec()
    ...
    unilib.register_node("unilib:tree_wirewood_trunk", "australia:wirewood_tree", mode, {
        ...
        description = unilib.utils.annotate(S("Wirewood Tree Trunk"), sci_name),
        tiles = {
    ...
    unilib.register_tree_trunk_stripped({
        -- Original to unilib. Creates unilib:tree_wirewood_trunk_stripped
        part_name = "wirewood",
        orig_name = nil,

        replace_mode = mode,
        description = S("Wirewood Tree Trunk"),
    ...
    unilib.register_fence_gate_quick({
        -- Original to unilib. Creates unilib:gate_wirewood_closed, etc
        part_name = "wirewood",
        orig_name = {nil, nil},
    ...
    for i = 1, 2 do
        ...
        unilib.register_decoration_generic("australia_tree_wirewood_in_central_" .. i, {
            -- From australia/biome_central_australia.lua
            deco_type = "schematic",
            schematic = unilib.core.path_mod .. "/mts/unilib_tree_wirewood_" .. i .. ".mts",
