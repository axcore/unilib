...
function unilib.pkg.deco_xocean_coral_block_bubble.init()
    ...
    return {
        ...
        depends = {"coral_block_bubble", "liquid_water_ordinary", "sand_ordinary", "shared_xocean"},
        at_least_one = {
...
function unilib.pkg.deco_xocean_coral_block_bubble.exec()
    ...
    --[[
    unilib.register_decoration_generic("xocean_coral_block_bubble_1", {
        -- From xocean/init.lua
        deco_type = "schematic",
        schematic = unilib.core.path_mod .. "/mts/unilib_coral_block_bubble_1.mts",
    ...
    unilib.register_decoration_generic("xocean_coral_block_bubble_2", {
        -- From xocean/init.lua
        deco_type = "schematic",
        schematic = unilib.core.path_mod .. "/mts/unilib_coral_block_bubble_2.mts",
    ...
    unilib.pkg.shared_xocean.create_generic_rare_block("bubble", 20)
    unilib.pkg.shared_xocean.create_generic_common_block("bubble", 28)
...
function unilib.pkg.deco_xocean_coral_block_bubble.post()
    ...
    --[[
    unilib.register_decoration_complete("xocean_coral_block_bubble_1", nil, {
        -- From xocean/init.lua
        biomes = {
    ...
    unilib.register_decoration_complete("xocean_coral_block_bubble_2", nil, {
        -- From xocean/init.lua
        biomes = {
            "default_desert_cold_ocean",
            "default_desert_sandstone_ocean",
    ...
    for i = 1, 2 do
        ...
        unilib.register_decoration_complete("xocean_coral_block_bubble_" .. i, nil, {
            -- From xocean/init.lua
            biomes = {
                "default_desert_cold_ocean",
                "default_desert_sandstone_ocean",
