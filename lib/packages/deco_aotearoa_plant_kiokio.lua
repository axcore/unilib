...
function unilib.pkg.deco_aotearoa_plant_kiokio.post()
    ...
    if unilib.global.pkg_executed_table["dirt_ordinary_with_litter_dry"] ~= nil or
    ...
    if unilib.global.pkg_executed_table["biome_aotearoa_lowland"] ~= nil and (
        unilib.global.pkg_executed_table["dirt_antipodean"] ~= nil or
        unilib.global.pkg_executed_table["dirt_ordinary_with_litter_dry"] ~= nil
    ) then
