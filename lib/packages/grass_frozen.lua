...
local function do_decoration(offset, scale, length)
    ...
    unilib.register_decoration("farlands_grass_frozen_" .. length, {
...
function unilib.pkg.grass_frozen.exec()
    ...
    -- First variant
    unilib.register_node("unilib:grass_frozen_1", nil, mode, {
        ...
        on_place = function(itemstack, placer, pointed_thing)
            ...
            return ItemStack("unilib:grass_frozen_1 " ..
    ...
    unilib.register_craft({
        -- Original to unilib
        type = "fuel",
        recipe = "unilib:grass_frozen_1",
        burntime = 2,
    })
    unilib.register_plant_in_pot("unilib:grass_frozen_1", nil)
