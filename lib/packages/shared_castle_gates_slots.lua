...
unilib.pkg.shared_castle_gates_slots = {}
...
function unilib.pkg.shared_castle_gates_slots.register_gateway_slot(data_table)
    ...
    unilib.register_node("unilib:" .. part_name .. "_slot", orig_slot_name, replace_mode, {
        description = unilib.utils.brackets(description, S("Gateway Slot")),
        tiles = img_list,
    ...
    unilib.register_node(
        ...
        replace_mode,
        {
            description = unilib.utils.brackets(description, S("Reverse Gateway Slot")),
            tiles = img_list,
            groups = ingredient_def_table.groups,
            sounds = ingredient_def_table.sounds,
...
function unilib.pkg.shared_castle_gates_slots.init()

    return {
        description = "Shared functions for gateway slots (from castle modpack)",
