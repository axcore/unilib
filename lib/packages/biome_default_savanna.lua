...
function unilib.pkg.biome_default_savanna.post()
    ...
    unilib.register_biome({
        ...
        description = unilib.brackets(S("Savanna biome"), "default"),
    ...
    unilib.register_biome({
        ...
        description = unilib.brackets(S("Savanna shore"), "default"),
    ...
    unilib.register_biome({
        ...
        description = unilib.brackets(S("Savanna ocean biome"), "default"),
    ...
    unilib.register_biome({
        ...
        description = unilib.brackets(S("Savanna deep ocean biome"), "default"),
        node_cave_liquid = {
