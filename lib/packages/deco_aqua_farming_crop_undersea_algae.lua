...
function unilib.pkg.deco_aqua_farming_crop_undersea_algae.post()
    ...
    if unilib.pkg_executed_table["sand_ordinary"] ~= nil then
        ...
        unilib.register_decoration_now("aqua_farming_crop_sea_algae_1", nil, {
    ...
    if unilib.pkg_executed_table["dirt_ordinary"] ~= nil then
        ...
        unilib.register_decoration_now("aqua_farming_crop_sea_algae_2", nil, {
            -- From aqua_farming/mapgen_sea_alga.lua
            -- Completes decoration in package "crop_undersea_algae"
            biomes = biome_list,
    ...
    if unilib.pkg_executed_table["sand_desert"] ~= nil then
        ...
        unilib.register_decoration_now("aqua_farming_crop_sea_algae_3", nil, {
            -- From aqua_farming/mapgen_sea_alga.lua
            -- Completes decoration in package "crop_undersea_algae"
            biomes = biome_list,
    ...
    if unilib.pkg_executed_table["sand_silver"] ~= nil then
        ...
        unilib.register_decoration_now("aqua_farming_crop_sea_algae_4", nil, {
            -- From aqua_farming/mapgen_sea_alga.lua
            -- Completes decoration in package "crop_undersea_algae"
            biomes = biome_list,
