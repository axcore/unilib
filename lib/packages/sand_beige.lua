...
function unilib.pkg.sand_beige.exec()
    ...
    if unilib.setting.squeezed_sand_flag then
        ...
        unilib.register_node("unilib:sand_beige_compressed", nil, mode, {
            -- Original to unilib
            description = S("Compressed Beige Sand"),
            tiles = {"unilib_sand_beige_compressed.png"},
        ...
        -- Original to unilib
        unilib.misc.set_squeezed_recipes("unilib:sand_beige", "unilib:sand_beige_compressed")
