...
function unilib.pkg.stone_sandstone_grey.exec()
    ...
    local smooth_cracky, block_cracky = unilib.get_adjusted_cracky("sandstone_grey", 3, 2)
    ...
    if unilib.pkg_executed_table["sand_river"] ~= nil then
    ...
    unilib.set_auto_rotate("unilib:stone_sandstone_grey_brick", unilib.auto_rotate_brick_flag)
