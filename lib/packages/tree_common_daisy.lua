...
function unilib.pkg.tree_common_daisy.exec()
    ...
    unilib.register_node("unilib:tree_common_daisy_trunk", "aotearoa:common_daisy_tree", mode, {
        ...
        description = unilib.annotate(S("Common Tree Daisy Trunk"), sci_name),
        tiles = {
    ...
    unilib.register_tree_sapling({
        ...
        schem_list = {
            {"unilib_tree_common_daisy_1", 2, 1, 2},
            {"unilib_tree_common_daisy_2", 2, 1, 2},
        },
        sci_name = sci_name,
        select_table = {-0.3, -0.5, -0.3, 0.3, 0.35, 0.3},
    })

    unilib.register_decoration("aotearoa_tree_common_daisy_clump_1", {
        -- From aotearoa/spawn_trees.lua
        deco_type = "schematic",
        schematic = unilib.path_mod .. "/mts/unilib_tree_common_daisy_1.mts",
    ...
    unilib.register_decoration("aotearoa_tree_common_daisy_clump_2", {
        -- From aotearoa/spawn_trees.lua
        deco_type = "schematic",
        schematic = unilib.path_mod .. "/mts/unilib_tree_common_daisy_2.mts",
    ...
    for i = 1, 2 do
        ...
        unilib.register_decoration("aotearoa_tree_common_daisy_rare_" .. i, {
            -- From aotearoa/spawn_trees.lua
            deco_type = "schematic",
            schematic = unilib.path_mod .. "/mts/unilib_tree_common_daisy_" .. i .. ".mts",
