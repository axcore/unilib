...
unilib.pkg.deco_xocean_coral_rooted_rose = {}
...
function unilib.pkg.deco_xocean_coral_rooted_rose.init()

    return {
        description = "Rooted rose coral as decoration",
        depends = {"coral_rooted_rose", "shared_xocean"},
        at_least_one = {
...
function unilib.pkg.deco_xocean_coral_rooted_rose.post()

    --[[
    unilib.register_decoration_complete("xocean_coral_rooted_rose", nil, {
        -- From xocean/init.lua
        -- Completes decoration in package "coral_rooted_rose"
        biomes = {
    ...
    unilib.register_decoration_complete("xocean_coral_rooted_rose_skeleton", nil, {
        -- From xocean/init.lua
        -- Completes decoration in package "coral_rooted_rose"
        biomes = {
            "default_desert_cold_ocean",
    ...
    for _, part_name in pairs({"", "_skeleton"}) do
        ...
        unilib.register_decoration_complete("xocean_coral_rooted_rose" .. part_name, nil, {
            -- From xocean/init.lua
