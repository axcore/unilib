...
function unilib.pkg.mushroom_galerina.init()

    return {
        description = "Galerina mushroom",
    }

end

function unilib.pkg.mushroom_galerina.exec()
    ...
    unilib.register_node("unilib:mushroom_galerina", "herbs:mushroom_galerina", mode, {
        ...
        buildable_to = true,
        drawtype = "plantlike",
        inventory_image = "unilib_mushroom_galerina.png",
        paramtype = "light",
        selection_box = {
            type = "fixed",
