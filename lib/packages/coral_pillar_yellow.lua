...
unilib.pkg.coral_pillar_yellow = {}
...
function unilib.pkg.coral_pillar_yellow.init()

    return {
        description = "Yellow coral pillar",
...
function unilib.pkg.coral_pillar_yellow.exec()

    unilib.register_node("unilib:coral_pillar_yellow", nil, mode, {
        -- Original to unilib, adapted from lib_ecology:plant_coral_pillar
        description = S("Yellow Coral Pillar"),
        tiles = {"unilib_coral_pillar_yellow.png"},
