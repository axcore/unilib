...
function unilib.pkg.fruit_quandong_desert.exec()
    ...
    unilib.register_node("unilib:fruit_quandong_desert", "australia:quandong", mode, {
        ...
        after_place_node = function(pos, placer, itemstack)
            ...
            if placer:is_player() then
                core.set_node(pos, {name = "unilib:fruit_quandong_desert", param2 = 1})
            end

        end,

        on_use = unilib.cuisine.eat_on_use("unilib:fruit_quandong_desert", 1),
    })
    ...
    unilib.register_juice({
        ingredient = "unilib:fruit_quandong_desert",
        juice_description = S("Quandong"),
        juice_type = "quandong",
        rgb = "#960a0d",
