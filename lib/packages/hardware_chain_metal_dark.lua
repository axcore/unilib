...
unilib.pkg.hardware_chain_metal_dark = {}
...
function unilib.pkg.hardware_chain_metal_dark.init()
...
function unilib.pkg.hardware_chain_metal_dark.exec()

    unilib.register_node("unilib:hardware_chain_metal_dark", "morelights:chain_d", mode, {
        ...
        drawtype = "mesh",
        inventory_image = "unilib_hardware_chain_metal_dark_inv.png",
        ...
        wield_image = "unilib_hardware_chain_metal_dark_inv.png",
        ...
        on_place = function(itemstack, placer, pointed_thing)
            ...
            return unilib.pkg.shared_morelights.on_place_hanging(
                ...
                placer,
                pointed_thing,
                "unilib:hardware_chain_metal_dark_ceiling"
            )
    ...
    unilib.register_craft({
        -- From morelights:chain_d
        output = "unilib:hardware_chain_metal_dark",
        recipe = {
    ...
    unilib.register_node(
        ...
        mode,
        {
            ...
            drawtype = "mesh",
            drop = "unilib:hardware_chain_metal_dark",
            -- N.B. is_ground_content = false not in original code
            is_ground_content = false,
