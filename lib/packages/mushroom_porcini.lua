...
function unilib.pkg.mushroom_porcini.exec()
    ...
    unilib.register_node("unilib:mushroom_porcini", "nsspf:boletus_edulis", mode, {
        ...
        description = unilib.utils.annotate(S("Porcini Mushroom"), "Boletus edulis"),
        ...
        on_use = unilib.cuisine.eat_on_use("unilib:mushroom_porcini", 2),
    })
    ...
    unilib.register_node("unilib:mushroom_porcini_cooked", "nsspf:cooked_boletus_edulis", mode, {
        ...
        on_use = unilib.cuisine.eat_on_use("unilib:mushroom_porcini_cooked", 16),
    })
    ...
    unilib.register_decoration_generic("nsspf_mushroom_porcini", {
