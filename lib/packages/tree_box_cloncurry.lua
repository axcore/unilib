...
function unilib.pkg.tree_box_cloncurry.exec()
    ...
    unilib.register_fence_gate_quick({
        -- Original to unilib. Creates unilib:gate_box_cloncurry_closed, etc
        part_name = "box_cloncurry",
        orig_name = {nil, nil},
    ...
    for i = 1, 2 do
        ...
        unilib.register_decoration_generic("australia_tree_box_cloncurry_in_gulf_" .. i, {
            -- From australia/biome_gulf_of_carpentaria.lua
            deco_type = "schematic",
            schematic = unilib.core.path_mod .. "/mts/unilib_tree_box_cloncurry_" .. i .. ".mts",
