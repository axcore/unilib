...
function unilib.pkg.sand_red.exec()
    ...
    if unilib.setting.squeezed_sand_flag then
        ...
        unilib.register_node("unilib:sand_red_compressed", nil, mode, {
            -- Original to unilib
            description = S("Compressed Red Sand"),
            tiles = {"unilib_sand_red_compressed.png"},
        ...
        -- Original to unilib
        unilib.misc.set_squeezed_recipes("unilib:sand_red", "unilib:sand_red_compressed")
