...
function unilib.pkg.coral_rooted_bubble.init()
    ...
    return {
        ...
        depends = {"coral_block_bubble", "liquid_water_ordinary"},
    }
...
function unilib.pkg.coral_rooted_bubble.exec()
    ...
    unilib.register_node("unilib:coral_rooted_bubble", "xocean:bubble", mode, {
        ...
        after_destruct = function(pos, oldnode)
            core.set_node(pos, {name = "unilib:coral_block_bubble"})
        end,
...
--      on_place = on_place_coral,
        on_place = function(itemstack, placer, pointed_thing)
            ...
            return unilib.misc.place_in_medium(
                ...
                {
                    need_under = "unilib:coral_block_bubble",
    ...
    unilib.register_node("unilib:coral_rooted_bubble_skeleton", "xocean:skeleton_bubble", mode, {
        ...
        after_destruct = function(pos, oldnode)
            core.set_node(pos, {name = "unilib:coral_block_bubble_skeleton"})
        end,
...
--      on_place = on_place_skeleton,
        on_place = function(itemstack, placer, pointed_thing)
            ...
            return unilib.misc.place_in_medium(
                itemstack, placer, pointed_thing,
                {
                    need_under = "unilib:coral_block_bubble_skeleton",
                    need_above = "unilib:liquid_water_ordinary_source",
                    displace_flag = true,
                }
            )
    ...
    unilib.register_decoration_generic("xocean_coral_rooted_bubble", {
...
--      param2_max = 96,
    ...
    unilib.register_decoration_generic("xocean_coral_rooted_bubble_skeleton", {
        -- From xocean/init.lua
        deco_type = "simple",
