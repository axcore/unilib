...
function unilib.pkg.mushroom_larch_bolete.exec()
    ...
    unilib.register_node("unilib:mushroom_larch_bolete", "nsspf:suillus_grevillei", mode, {
        ...
        description = unilib.utils.annotate(S("Larch Bolete Mushroom"), "Suillus grevillei"),
        ...
        on_use = unilib.cuisine.eat_on_use("unilib:mushroom_larch_bolete", 1),
    })
    ...
    unilib.register_node(
        ...
        mode,
        {
            ...
            on_use = unilib.cuisine.eat_on_use("unilib:mushroom_larch_bolete_cooked", 10),
        }
    )
    ...
    unilib.register_decoration_generic("nsspf_mushroom_larch_bolete", {
