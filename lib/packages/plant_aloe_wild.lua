...
function unilib.pkg.plant_aloe_wild.init()

    return {
        description = "Wild aloe",
    }

end

function unilib.pkg.plant_aloe_wild.exec()
    ...
    unilib.register_node("unilib:plant_aloe_wild", "plants:aloe_wild", mode, {
        ...
        buildable_to = true,
        drawtype = "plantlike",
        inventory_image = "unilib_plant_aloe_wild.png",
        paramtype = "light",
        selection_box = {
            type = "fixed",
    ...
    unilib.register_decoration("plants_plant_aloe_wild", {
        ...
        noise_params = {
            ...
            persist = 0.7,
            scale = 0.1,
            seed = 58490,      -- New random seed, generated for unilib
