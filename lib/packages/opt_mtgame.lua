...
function unilib.pkg.opt_mtgame.init()
    ...
    return {
        description = "Optional stuff for the \"mtgame\" remix",
    }
...
function unilib.pkg.opt_mtgame.post()
    ...
    -- (From bucket)
    core.register_alias_force("bucket", "unilib:bucket_steel_empty")
    core.register_alias_force("bucket_water", "unilib:bucket_steel_with_water_ordinary")
    core.register_alias_force("bucket_lava", "unilib:bucket_steel_with_lava_ordinary")
