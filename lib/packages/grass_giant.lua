...
function unilib.pkg.grass_giant.exec()
    ...
    unilib.register_node("unilib:grass_giant", "mapgen:giantgrass", mode, {
    ...
    unilib.register_plant_in_pot("unilib:grass_giant", "mapgen:giantgrass")

    unilib.register_decoration("farlands_grass_giant", {
        -- From farlands, mapgen/mapgen.lua
        deco_type = "simple",
        decoration = "unilib:grass_giant",
