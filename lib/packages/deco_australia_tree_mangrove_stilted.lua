...
function unilib.pkg.deco_australia_tree_mangrove_stilted.post()
    ...
    for i = 1, 3 do
        ...
        unilib.register_decoration_now("australia_tree_mangrove_stilted_in_mangroves_" .. i, nil, {
            -- From australia/biome_mangroves.lua
            biomes = "australia_mangroves",
            place_on = {"unilib:dirt_mud_mangrove", "unilib:dirt_ordinary", "unilib:sand_ordinary"},
            y_max = 3,
            y_min = -2,
        })
