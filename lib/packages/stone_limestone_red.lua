...
function unilib.pkg.stone_limestone_red.exec()
    ...
    unilib.register_stone_rubble_compressed({
        -- Original to unilib. Creates unilib:stone_limestone_red_rubble_compressed
        part_name = "limestone_red",
        orig_name = nil,

        replace_mode = mode,
        description = S("Compressed Red Limestone Rubble"),
    })

    unilib.register_stone_rubble_condensed({
        -- Original to unilib. Creates unilib:stone_limestone_red_rubble_condensed
        part_name = "limestone_red",
        orig_name = nil,

        replace_mode = mode,
        description = S("Condensed Red Limestone Rubble"),
    })
