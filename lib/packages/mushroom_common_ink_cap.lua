...
function unilib.pkg.mushroom_common_ink_cap.exec()
    ...
    unilib.register_node("unilib:mushroom_common_ink_cap", "nsspf:coprinus_atramentarius", mode, {
        ...
        description = unilib.utils.annotate(S("Common Ink Cap Mushroom"), "Coprinus atramentarius"),
        ...
        on_use = unilib.cuisine.eat_on_use("unilib:mushroom_common_ink_cap", -13),
    })
    ...
    unilib.register_node(
        ...
        mode,
        {
            ...
            on_use = unilib.cuisine.eat_on_use("unilib:mushroom_common_ink_cap_cooked", 6),
        }
    )
    ...
    unilib.register_decoration_generic("nsspf_mushroom_common_ink_cap", {
