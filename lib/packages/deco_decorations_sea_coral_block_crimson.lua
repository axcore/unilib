...
function unilib.pkg.deco_decorations_sea_coral_block_crimson.init()

    return {
        description = "crimson corals as decoration",
        depends = {
            "coral_block_crimson",
...
function unilib.pkg.deco_decorations_sea_coral_block_crimson.post()
