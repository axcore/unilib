...
function unilib.pkg.mushroom_puffball.exec()
    ...
    unilib.register_node("unilib:mushroom_puffball", "nsspf:lycoperdon_pyriforme", mode, {
        ...
        description = unilib.utils.annotate(S("Puffball Mushroom"), "Lycoperdon pyriforme"),
        ...
        on_use = unilib.cuisine.eat_on_use("unilib:mushroom_puffball", 8),
    })
    ...
    unilib.register_node(
        ...
        mode,
        {
            ...
            on_use = unilib.cuisine.eat_on_use("unilib:mushroom_puffball_cooked", 12),
        }
    )
    ...
    unilib.register_decoration_generic("nsspf_mushroom_puffball", {
