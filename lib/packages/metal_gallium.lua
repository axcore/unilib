...
function unilib.pkg.metal_gallium.exec()
    ...
    unilib.register_stairs("unilib:metal_gallium_block")
    unilib.register_carvings("unilib:metal_gallium_block", {
        millwork_flag = true,
    })

    if unilib.setting.squeezed_metal_flag then

        unilib.register_node("unilib:metal_gallium_block_compressed", nil, mode, {
            -- Original to unilib
            description = S("Compressed Gallium Block"),
            tiles = {"unilib_metal_gallium_block_compressed.png"},
        ...
        unilib.misc.set_compressed_metal_recipes("gallium")
