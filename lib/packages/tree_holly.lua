...
function unilib.pkg.tree_holly.exec()
    ...
    unilib.register_fence_gate_quick({
        -- From hollytree:gate_closed, etc. Creates unilib:gate_holly_closed, etc
        part_name = "holly",
    ...
    unilib.register_decoration_generic("cool_trees_tree_holly", {
        -- From hollytree/init.lua
        deco_type = "schematic",
        schematic = unilib.core.path_mod .. "/mts/unilib_tree_holly.mts",
