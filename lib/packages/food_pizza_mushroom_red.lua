...
function unilib.pkg.food_pizza_mushroom_red.exec()
    ...
    unilib.register_craft({
        ...
        recipe = {
            ...
            {"unilib:mushroom_red", "unilib:ingredient_sauce_tomato", "unilib:mushroom_red"},
            {"unilib:mushroom_red", "unilib:ingredient_dough_pizza", "unilib:mushroom_red"},
        },
    })
    ...
    unilib.register_craftitem("unilib:food_pizza_mushroom_red_slice", "pizza:rmush", mode, {
        ...
        on_use = unilib.cuisine_eat_on_use("unilib:food_pizza_mushroom_red_slice", -1),
    })
    unilib.register_craft({
        -- From pizza:rmush
        type = "cooking",
