...
function unilib.pkg.tree_beech_mountain.exec()
    ...
    unilib.register_fence_gate_quick({
        -- From aotearoa:gate_mountain_beech_wood. Creates unilib:gate_beech_mountain_closed
        part_name = "beech_mountain",
        orig_name = {
    ...
    for i = 1, 2 do
        ...
        unilib.register_decoration("aotearoa_tree_beech_mountain_dense_" .. i, {
            -- From aotearoa/spawn_trees.lua
            deco_type = "schematic",
            schematic = unilib.path_mod .. "/mts/unilib_tree_beech_mountain_" .. i .. ".mts",
        ...
        unilib.register_decoration("aotearoa_tree_beech_mountain_rare_" .. i, {
            -- From aotearoa/spawn_trees.lua
            deco_type = "schematic",
            schematic = unilib.path_mod .. "/mts/unilib_tree_beech_mountain_" .. i .. ".mts",
