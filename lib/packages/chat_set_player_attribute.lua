...
unilib.pkg.chat_set_player_attribute = {}
...
function unilib.pkg.chat_set_player_attribute.init()

    return {
        description = "Chat command /set_player_attribute",
        notes = "Sets the value of a player attribute",
    }

end

function unilib.pkg.chat_set_player_attribute.exec()

    core.register_chatcommand("set_player_attribute", {
        ...
        func = function(name, param)
            ...
            elseif not player.get_meta then
                ...
                elseif param_list[2] == nil or param_list[2] == "" then
                    ...
                    return false,
                            S("You must specify an attribute value (try /reset_player)attribute)")
                    ...
                    unilib.utils.set_player_attribute(player, param_list[1], param_list[2])
