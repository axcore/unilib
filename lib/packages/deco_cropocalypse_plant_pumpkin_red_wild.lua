...
function unilib.pkg.deco_cropocalypse_plant_pumpkin_red_wild.init()
    ...
    return {
        ...
        depends = {"biome_default_grassland", "dirt_ordinary_with_turf", "plant_pumpkin_red_wild"},
    }
...
function unilib.pkg.deco_cropocalypse_plant_pumpkin_red_wild.post()
    ...
    unilib.register_decoration_complete("cropocalypse_plant_pumpkin_red_wild", nil, {
