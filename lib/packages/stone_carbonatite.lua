...
function unilib.pkg.stone_carbonatite.exec()
    ...
    unilib.register_stone_rubble_compressed({
        -- Original to unilib. Creates unilib:stone_carbonatite_rubble_compressed
        part_name = "carbonatite",
        orig_name = nil,

        replace_mode = mode,
        description = S("Compressed Carbonatite Rubble"),
    })

    unilib.register_stone_rubble_condensed({
        -- Original to unilib. Creates unilib:stone_carbonatite_rubble_condensed
        part_name = "carbonatite",
        orig_name = nil,

        replace_mode = mode,
        description = S("Condensed Carbonatite Rubble"),
    })
