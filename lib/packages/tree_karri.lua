...
function unilib.pkg.tree_karri.exec()
    ...
    unilib.register_fence_gate_quick({
        -- Original to unilib. Creates unilib:gate_karri_closed
        part_name = "karri",
        orig_name = {nil, nil},
    ...
    for i = 1, 3 do
        ...
        unilib.register_decoration("australia_tree_karri_in_forests_" .. i, {
            -- From australia/biome_jarrah_karri_forests.lua
            deco_type = "schematic",
            schematic = unilib.path_mod .. "/mts/unilib_tree_karri_" .. i .. ".mts",
