...
function unilib.pkg.plant_waratah.exec()
    ...
    unilib.register_node("unilib:plant_waratah", "australia:waratah", mode, {
        ...
        description = unilib.annotate(S("Waratah"), "Telopea speciosissima"),
    ...
    unilib.register_decoration("australia_plant_waratah", {
        -- From australia/biome_eastern_coasts.lua
        deco_type = "schematic",
        schematic = unilib.path_mod .. "/mts/unilib_plant_waratah.mts",
