...
function unilib.pkg.misc_sponge.init()
    ...
    return {
        ...
        notes = "Dry sponges soak up water in a radius of 3 blocks. Wet sponges can be dried" ..
                " in a furnace. Because of code in the \"sand_undersea\" mod, grows" ..
                " spontaneuously on undersea sand",
    }
        ...
        after_place_node = function(pos, placer, itemstack, pointed_thing)
            ...
            for _, w in pairs(num) do
                ...
                if not core.is_protected(pos, name) then
                    core.set_node(w, {name = "unilib:misc_sponge_air"})
                end

            end

            -- Replace dry sponge with wet sponge
            core.set_node(pos, {name = "unilib:misc_sponge_wet"})
