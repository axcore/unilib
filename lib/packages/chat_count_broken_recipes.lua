...
unilib.pkg.chat_count_broken_recipes = {}
...
function unilib.pkg.chat_count_broken_recipes.init()

    return {
        description = "Chat command /count_broken_recipes",
        notes = "Checks for missing recipe ingredients, displaying the total number found",
        depends = "shared_chat_missing",
    }

end

function unilib.pkg.chat_count_broken_recipes.exec()

    core.register_chatcommand("count_broken_recipes", {
        params = "",
