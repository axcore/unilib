...
function unilib.pkg.glass_tinted_basic.init()
...
function unilib.pkg.glass_tinted_basic.exec()
    ...
    for _, row_list in ipairs(glass_list) do
        ...
        unilib.register_stairs("unilib:glass_tinted_" .. part_name, {
            glass_flag = true,
        })
        unilib.register_carvings("unilib:glass_tinted_" .. part_name, {
            millwork_flag = true,
        })
