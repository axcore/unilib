...
function unilib.pkg.food_cheese_vegan.init()
    ...
    return {
        ...
        optional = {"vessel_bottle_glass_with_ethanol", "vessel_bottle_glass_empty"},
        suggested = {
...
function unilib.pkg.food_cheese_vegan.exec()
    ...
    unilib.register_craftitem("unilib:food_cheese_vegan", "farming:cheese_vegan", mode, {
        ...
        on_use = unilib.cuisine.eat_on_use("unilib:food_cheese_vegan", 2),
    })
    ...
    if unilib.global.pkg_executed_table["vessel_bottle_glass_with_ethanol"] ~= nil and
            unilib.global.pkg_executed_table["vessel_bottle_glass_empty"] ~= nil then
