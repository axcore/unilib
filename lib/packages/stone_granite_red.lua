...
function unilib.pkg.stone_granite_red.exec()
    ...
    local smooth_cracky, block_cracky = unilib.stone.get_adjusted_cracky("granite_red", 3, nil)
    ...
    unilib.register_stone_cobble_or_rubble_or_nothing({
        ...
        cobble_compressed_description = S("Compressed Red Granite Cobble"),
        cobble_condensed_description = S("Condensed Red Granite Cobble"),
        rubble_description = S("Red Granite Rubble"),
        rubble_compressed_description = S("Compressed Red Granite Rubble"),
        rubble_condensed_description = S("Condensed Red Granite Rubble"),
        smooth_compressed_description = S("Compressed Red Granite"),
        smooth_condensed_description = S("Condensed Red Granite"),
