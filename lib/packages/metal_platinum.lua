...
function unilib.pkg.metal_platinum.exec()
    ...
    unilib.register_stairs("unilib:metal_platinum_block")
    unilib.register_carvings("unilib:metal_platinum_block", {
        millwork_flag = true,
    })

    if unilib.setting.squeezed_metal_flag then

        unilib.register_node("unilib:metal_platinum_block_compressed", nil, mode, {
            -- Original to unilib
            description = S("Compressed Platinum Block"),
            tiles = {"unilib_metal_platinum_block_compressed.png"},
        ...
        unilib.misc.set_compressed_metal_recipes("platinum")
