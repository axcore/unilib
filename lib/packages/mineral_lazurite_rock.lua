...
function unilib.pkg.mineral_lazurite_rock.init()

    return {
        description = "Lazurite rock (as mineral)",
        notes = "An alternative to the stone ores with lazurite",
        depends = "mineral_lazurite",
    }
...
function unilib.pkg.mineral_lazurite_rock.exec()
    ...
    unilib.register_node("unilib:mineral_lazurite_rock", nil, mode, {
        -- Original to unilib
        ...
        drop = {
            max_items = 1,
            items = {
                {items = {"unilib:mineral_lazurite_rock"}, rarity = (100 * hardness)},
