...
function unilib.pkg.stone_chalk_yellow.exec()
    ...
    unilib.register_stone_cobble_compressed({
        -- Original to unilib. Creates unilib:stone_chalk_yellow_cobble_compressed
        part_name = "chalk_yellow",
        orig_name = nil,

        replace_mode = mode,
        description = S("Compressed Yellow Chalk Cobble"),
    })

    unilib.register_stone_cobble_condensed({
        -- Original to unilib. Creates unilib:stone_chalk_yellow_cobble_condensed
        part_name = "chalk_yellow",
        orig_name = nil,

        replace_mode = mode,
        description = S("Condensed Yellow Chalk Cobble"),
    })
