...
function unilib.pkg.tree_spruce.exec()
    ...
    unilib.register_leafdecay({
        ...
        leaves = {"unilib:tree_spruce_leaves"},
        others = {"unilib:ingredient_cone_spruce"},
        radius = 5,
    })
    ...
    unilib.register_fence_gate_quick({
        -- From moretrees:spruce_gate_closed, etc. Creates unilib:gate_spruce_closed, etc
        part_name = "spruce",
    ...
    unilib.register_decoration_convertable({
        ...
        climate_table = {
            temp_max = unilib.utils.convert_biome_lib_temp(0.7),
