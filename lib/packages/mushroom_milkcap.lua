...
function unilib.pkg.mushroom_milkcap.init()

    return {
        description = "Milkcap mushroom",
    }

end

function unilib.pkg.mushroom_milkcap.exec()

    unilib.register_node("unilib:mushroom_milkcap", "lib_ecology:mushroom_milkcap", mode, {
        -- From GLEMr11, lib_ecology:mushroom_milkcap
        description = S("Milkcap Mushroom"),
        tiles = {"unilib_mushroom_milkcap.png"},
