...
function unilib.pkg.tree_kauri.exec()
    ...
    unilib.register_fence_gate_quick({
        -- From aotearoa:gate_kauri_wood_closed, etc. Creates unilib:gate_kauri_closed, etc
        part_name = "kauri",
    ...
    for i = 1, 2 do
        ...
        unilib.register_decoration_generic("aotearoa_tree_kauri_normal_" .. i, {
            -- From aotearoa/spawn_trees.lua
            deco_type = "schematic",
            schematic = unilib.core.path_mod .. "/mts/unilib_tree_kauri_" .. i .. ".mts",
