...
function unilib.pkg.door_wood_willow_exotic.init()

    return {
        description = "Exotic willow wood door",
        depends = "tree_willow_exotic",
    }
...
function unilib.pkg.door_wood_willow_exotic.exec()
    ...
    unilib.register_door({
        ...
        def_table = {
            ...
            inventory_image = "unilib_door_wood_willow_exotic_inv.png",
            recipe = {
                {"unilib:tree_willow_exotic_wood", "unilib:tree_willow_exotic_wood"},
                {"unilib:tree_willow_exotic_wood", "unilib:tree_willow_exotic_wood"},
                {"unilib:tree_willow_exotic_wood", "unilib:tree_willow_exotic_wood"},
            },
        },
