...
function unilib.pkg.stone_gneiss_white.exec()
    ...
    local smooth_cracky, block_cracky = unilib.get_adjusted_cracky("gneiss_white", 3, 2)
    ...
    unilib.set_auto_rotate("unilib:stone_gneiss_white_brick", unilib.auto_rotate_brick_flag)
