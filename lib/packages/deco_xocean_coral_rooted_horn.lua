...
unilib.pkg.deco_xocean_coral_rooted_horn = {}
...
function unilib.pkg.deco_xocean_coral_rooted_horn.init()

    return {
        description = "Rooted horn coral as decoration",
        depends = {"coral_rooted_horn", "shared_xocean"},
        at_least_one = {
...
function unilib.pkg.deco_xocean_coral_rooted_horn.post()

    --[[
    unilib.register_decoration_complete("xocean_coral_rooted_horn", nil, {
        -- From xocean/init.lua
        -- Completes decoration in package "coral_rooted_horn"
        biomes = {
    ...
    unilib.register_decoration_complete("xocean_coral_rooted_horn_skeleton", nil, {
        -- From xocean/init.lua
        -- Completes decoration in package "coral_rooted_horn"
        biomes = {
            "default_desert_cold_ocean",
    ...
    for _, part_name in pairs({"", "_skeleton"}) do
        ...
        unilib.register_decoration_complete("xocean_coral_rooted_horn" .. part_name, nil, {
            -- From xocean/init.lua
