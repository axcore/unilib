...
function unilib.pkg.deco_xocean_coral_rooted_bubble.init()
    ...
    return {
        ...
        depends = {"coral_rooted_bubble", "shared_xocean"},
        at_least_one = {
...
function unilib.pkg.deco_xocean_coral_rooted_bubble.post()
    ...
    --[[
    unilib.register_decoration_complete("xocean_coral_rooted_bubble", nil, {
    ...
    unilib.register_decoration_complete("xocean_coral_rooted_bubble_skeleton", nil, {
        -- From xocean/init.lua
        -- Completes decoration in package "coral_rooted_bubble"
        biomes = {
            "default_desert_cold_ocean",
    ...
    for _, part_name in pairs({"", "_skeleton"}) do
        ...
        unilib.register_decoration_complete("xocean_coral_rooted_bubble" .. part_name, nil, {
            -- From xocean/init.lua
