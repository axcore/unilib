...
function unilib.pkg.shared_morebricks.register_bricks(data_table)
    ...
    unilib.register_node(vertical_full_name, vertical_orig_name, replace_mode, {
        description = unilib.utils.brackets(description, S("Vertical")),
...
function unilib.pkg.shared_morebricks.init()

    return {
        description = "Shared functions for coloured brick blocks (from morebricks)",
    }
