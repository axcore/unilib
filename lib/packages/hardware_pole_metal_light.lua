...
unilib.pkg.hardware_pole_metal_light = {}
...
function unilib.pkg.hardware_pole_metal_light.init()
...
function unilib.pkg.hardware_pole_metal_light.exec()

    unilib.register_node("unilib:hardware_pole_metal_light", "morelights:pole_l", mode, {
        ...
        drawtype = "nodebox",
        inventory_image = "unilib_hardware_pole_metal_light_inv.png",
        ...
        wield_image = "unilib_hardware_pole_metal_light_inv.png",
        ...
        on_place = function(itemstack, placer, pointed_thing)
            ...
            return unilib.pkg.shared_morelights.on_place_hanging(
                ...
                placer,
                pointed_thing,
                "unilib:hardware_pole_metal_light_ceiling"
            )
    ...
    unilib.register_craft({
        -- From morelights:pole_l
        output = "unilib:hardware_pole_metal_light 2",
        recipe = {
    ...
    unilib.register_node(
        ...
        mode,
        {
            ...
            drawtype = "nodebox",
            drop = "unilib:hardware_pole_metal_light",
            -- N.B. is_ground_content = false not in original code
            is_ground_content = false,
            node_box = {
                type = "fixed",
