...
unilib.pkg.pole_metal_dark_street = {}
...
function unilib.pkg.pole_metal_dark_street.init()
...
function unilib.pkg.pole_metal_dark_street.exec()
    ...
    unilib.register_node(
        ...
        mode,
        {
            description = unilib.hint(S("Dark Lamp Post"), S("connects to street lights")),
    ...
    unilib.register_craft({
        -- From morelights_modern:streetpost_d
        output = "unilib:pole_metal_dark_street 2",
        recipe = {
