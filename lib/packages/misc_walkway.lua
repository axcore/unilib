...
unilib.pkg.misc_walkway = {}

local S = unilib.intllib
local mode = unilib.imported_mod_table.factory_bridges.add_mode
...
function unilib.pkg.misc_walkway.init()
...
function unilib.pkg.misc_walkway.exec()

    local hatch_img = "unilib_misc_walkway_hatch.png"
    local platform_img = "unilib_misc_walkway_platform.png"
    local steps_img = "unilib_misc_walkway_steps.png"
    local support_img = "unilib_misc_walkway_support.png"

    -- Support structures

    unilib.register_node("unilib:misc_walkway_support_1", "factory_bridges:a01", mode, {
        -- From factory_bridges:a01
        description = unilib.brackets(S("Walkway Support"), S("One corner post")),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:a01
        output = "unilib:misc_walkway_support_1",
        recipe = {
            {"", "unilib:misc_walkway_item_block", ""},
            {"", "unilib:misc_walkway_item_pole", ""},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_support_2", "factory_bridges:a02", mode, {
        -- From factory_bridges:a02
        description = unilib.brackets(S("Walkway Support"), S("Two corner posts")),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:a02
        output = "unilib:misc_walkway_support_2",
        recipe = {
            {"unilib:misc_walkway_support_1", "", "unilib:misc_walkway_support_1"},
            {"", "", ""},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_support_3", "factory_bridges:a03", mode, {
        -- From factory_bridges:a03
        description = unilib.brackets(S("Walkway Support"), S("Three corner posts")),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:a03
        output = "unilib:misc_walkway_support_3",
        recipe = {
            {"unilib:misc_walkway_support_1", "", "unilib:misc_walkway_support_1"},
            {"", "", ""},
            {"", "", "unilib:misc_walkway_support_1"},
        },
    })

    unilib.register_node("unilib:misc_walkway_support_4", "factory_bridges:a04", mode, {
        -- From factory_bridges:a04
        description = unilib.brackets(S("Walkway Support"), S("Four corner posts")),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:a04
        output = "unilib:misc_walkway_support_4",
        recipe = {
            {"unilib:misc_walkway_support_1", "", "unilib:misc_walkway_support_1"},
            {"", "", ""},
            {"unilib:misc_walkway_support_1", "", "unilib:misc_walkway_support_1"},
    ...
    unilib.register_node("unilib:misc_walkway_support_5", "factory_bridges:a05", mode, {
        -- From factory_bridges:a05
        description = unilib.brackets(S("Walkway Support"), S("Remote control")),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:a05
        output = "unilib:misc_walkway_support_5",
        recipe = {
            {"", "unilib:misc_walkway_item_beam", ""},
            {"unilib:misc_walkway_item_pole", "", "unilib:misc_walkway_item_pole"},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_support_6", "factory_bridges:a05dia", mode, {
        -- From factory_bridges:a05dia
        description = unilib.brackets(S("Walkway Support"), S("Diagonal corner posts")),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:a05dia
        output = "unilib:misc_walkway_support_6",
        recipe = {
            {"unilib:misc_walkway_support_5", "", ""},
            {"", "unilib:misc_walkway_support_5", ""},
            {"", "", "unilib:misc_walkway_support_5"},
        },
    })

    unilib.register_node("unilib:misc_walkway_support_7", "factory_bridges:a06", mode, {
        -- From factory_bridges:a06
        description = unilib.brackets(
            S("Walkway Support"), S("Far handrail, near right-corner post")
        ),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:a06
        output = "unilib:misc_walkway_support_7",
        recipe = {
            {"", "unilib:misc_walkway_support_5", ""},
            {"", "", ""},
            {"", "", "unilib:misc_walkway_support_1"},
    ...
    unilib.register_node("unilib:misc_walkway_support_8", "factory_bridges:a07", mode, {
        -- From factory_bridges:a07
        description = unilib.brackets(
            S("Walkway Support"), S("Far handrail, near left-corner post")
        ),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:a07
        output = "unilib:misc_walkway_support_8",
        recipe = {
            {"", "unilib:misc_walkway_support_5", ""},
            {"", "", ""},
            {"unilib:misc_walkway_support_1", "", ""},
    ...
    unilib.register_node("unilib:misc_walkway_support_9", "factory_bridges:a08", mode, {
        -- From factory_bridges:a08
        description = unilib.brackets(S("Walkway Support"), S("Far handrail, near-corner posts")),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:a08
        output = "unilib:misc_walkway_support_9",
        recipe = {
            {"", "unilib:misc_walkway_support_5", ""},
            {"", "", ""},
            {"unilib:misc_walkway_support_1", "", "unilib:misc_walkway_support_1"},
    ...
    unilib.register_node("unilib:misc_walkway_support_10", "factory_bridges:a09", mode, {
        -- From factory_bridges:a09
        description = unilib.brackets(S("Walkway Support"), S("Far and left railings")),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:a09
        output = "unilib:misc_walkway_support_10",
        recipe = {
            {"", "unilib:misc_walkway_support_5", ""},
            {"unilib:misc_walkway_support_5", "", ""},
            {"", "", ""},
    ...
    unilib.register_node("unilib:misc_walkway_support_11", "factory_bridges:a10", mode, {
        -- From factory_bridges:a10
        description = unilib.brackets(
            S("Walkway Support"), S("Far and left railings, near right-corner post")
        ),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:a10
        output = "unilib:misc_walkway_support_11",
        recipe = {
            {"", "unilib:misc_walkway_support_5", ""},
            {"unilib:misc_walkway_support_5", "", ""},
            {"", "", "unilib:misc_walkway_support_1"},
    ...
    unilib.register_node("unilib:misc_walkway_support_12", "factory_bridges:a11", mode, {
        -- From factory_bridges:a11
        description = unilib.brackets(S("Walkway Support"), S("Left and right railings")),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:a11
        output = "unilib:misc_walkway_support_12",
        recipe = {
            {"", "", ""},
            {"unilib:misc_walkway_support_5", "", "unilib:misc_walkway_support_5"},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_support_13", "factory_bridges:a12", mode, {
        -- From factory_bridges:a12
        description = unilib.brackets(S("Walkway Support"), S("Left, right and far railings")),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:a12
        output = "unilib:misc_walkway_support_13",
        recipe = {
            {"", "unilib:misc_walkway_support_5", ""},
            {"unilib:misc_walkway_support_5", "", "unilib:misc_walkway_support_5"},
            {"", "", ""},
    ...
    unilib.register_node("unilib:misc_walkway_support_14", "factory_bridges:a13", mode, {
        -- From factory_bridges:a13
        description = unilib.brackets(S("Walkway Support"), S("Sloping left handrail")),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:a13
        output = "unilib:misc_walkway_support_14",
        recipe = {
            {"", "unilib:misc_walkway_item_beam", "unilib:misc_walkway_item_pole"},
            {"", "unilib:misc_walkway_item_pole", ""},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_support_15", "factory_bridges:a14", mode, {
        -- From factory_bridges:a14
        description = unilib.brackets(S("Walkway Support"), S("Sloping right handrail")),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:a14
        output = "unilib:misc_walkway_support_15",
        recipe = {
            {"unilib:misc_walkway_item_pole", "unilib:misc_walkway_item_beam", ""},
            {"", "unilib:misc_walkway_item_pole", ""},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_support_16", "factory_bridges:a15", mode, {
        -- From factory_bridges:a15
        description = unilib.brackets(S("Walkway Support"), S("Inclined double handrail")),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:a15
        output = "unilib:misc_walkway_support_16",
        recipe = {
            {"", "", ""},
            {"unilib:misc_walkway_support_14", "", "unilib:misc_walkway_support_15"},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_support_17", "factory_bridges:s00", mode, {
        -- From factory_bridges:s00
        description = unilib.brackets(S("Walkway Support"), S("Open vertical staircase")),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:s00
        output = "unilib:misc_walkway_support_17",
        recipe = {
            {"", "unilib:misc_walkway_item_pole", ""},
            {"unilib:misc_walkway_item_beam", "", "unilib:misc_walkway_item_beam"},
            {"", "unilib:misc_walkway_item_pole", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_support_18", "factory_bridges:s01", mode, {
        -- From factory_bridges:s01
        description = unilib.brackets(S("Walkway Support"), S("Closed vertical staircase")),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:s01
        output = "unilib:misc_walkway_support_18",
        recipe = {
            {
                "unilib:misc_walkway_item_beam",
                "unilib:misc_walkway_item_beam",
            ...
            {
                "unilib:misc_walkway_item_beam",
                "unilib:misc_walkway_support_17",
                "unilib:misc_walkway_item_beam",
            },
            {
                "unilib:misc_walkway_item_beam",
    ...
    unilib.register_node("unilib:misc_walkway_support_19", "factory_bridges:s02", mode, {
        -- From factory_bridges:s02
        description = unilib.brackets(S("Walkway Support"), S("Top of vertical ladder")),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:s02
        output = "unilib:misc_walkway_support_19",
        recipe = {
            {
                "unilib:misc_walkway_item_beam",
                "unilib:misc_walkway_item_beam",
    ...
    unilib.register_node("unilib:misc_walkway_support_20", "factory_bridges:s03", mode, {
        -- From factory_bridges:s03
        description = unilib.brackets(S("Walkway Support"), S("Staircase with exit to right")),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:s03
        output = "unilib:misc_walkway_support_20",
        recipe = {
            {"unilib:misc_walkway_item_beam", "", ""},
            {"unilib:misc_walkway_item_beam", "unilib:misc_walkway_support_17", ""},
            {"unilib:misc_walkway_item_beam", "unilib:misc_walkway_item_beam", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_support_21", "factory_bridges:s04", mode, {
        -- From factory_bridges:s04
        description = unilib.brackets(S("Walkway Support"), S("Staircase with exit to left")),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:s04
        output = "unilib:misc_walkway_support_21",
        recipe = {
            {"", "", "unilib:misc_walkway_item_beam"},
            {"", "unilib:misc_walkway_support_17", "unilib:misc_walkway_item_beam"},
            {"", "unilib:misc_walkway_item_beam", "unilib:misc_walkway_item_beam"},
        },
    })

    unilib.register_node("unilib:misc_walkway_support_22", "factory_bridges:s05", mode, {
        -- From factory_bridges:s05
        description = unilib.brackets(S("Walkway Support"), S("Staircase with dual exits")),
        tiles = {support_img},
        groups = {cracky = 2},
        -- (no sounds)
    ...
    unilib.register_craft({
        -- From factory_bridges:s05
        output = "unilib:misc_walkway_support_22",
        recipe = {
            {"", "", ""},
            {"", "unilib:misc_walkway_support_17", ""},
            {"unilib:misc_walkway_item_beam", "", "unilib:misc_walkway_item_beam"},
    ...
    unilib.register_node("unilib:misc_walkway_platform_1", "factory_bridges:b00", mode, {
        -- From factory_bridges:b00
        description = unilib.brackets(S("Walkway Platform"), S("Bottom plate")),
    ...
    unilib.register_craft({
        -- From factory_bridges:b00
        output = "unilib:misc_walkway_platform_1 10",
        recipe = {
            {"unilib:metal_steel_ingot", "unilib:metal_steel_ingot", "unilib:metal_steel_ingot"},
        },
    })

    unilib.register_node("unilib:misc_walkway_platform_2", "factory_bridges:b01", mode, {
        -- From factory_bridges:b01
        description = unilib.brackets(S("Walkway Platform"), S("One corner post")),
        tiles = {platform_img, platform_img, support_img},
        groups = {cracky = 2},
        -- N.B. No sounds in original code
        sounds = unilib.sound_table.metal,
    ...
    unilib.register_craft({
        -- From factory_bridges:b01
        output = "unilib:misc_walkway_platform_2",
        recipe = {
            {"unilib:misc_walkway_support_1", "", ""},
            {"", "unilib:misc_walkway_platform_1", ""},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_platform_3", "factory_bridges:b02", mode, {
        -- From factory_bridges:b02
        description = unilib.brackets(S("Walkway Platform"), S("Two corner posts")),
        tiles = {platform_img, platform_img, support_img},
        groups = {cracky = 2},
        -- N.B. No sounds in original code
        sounds = unilib.sound_table.metal,
    ...
    unilib.register_craft({
        -- From factory_bridges:b02
        output = "unilib:misc_walkway_platform_3",
        recipe = {
            {"unilib:misc_walkway_support_1", "", "unilib:misc_walkway_support_1"},
            {"", "unilib:misc_walkway_platform_1", ""},
            {"", "", ""},
    ...
    unilib.register_craft({
        ...
        output = "unilib:misc_walkway_platform_3",
        recipe = {
            {"", "unilib:misc_walkway_support_2", ""},
            {"", "unilib:misc_walkway_platform_1", ""},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_platform_4", "factory_bridges:b03", mode, {
        -- From factory_bridges:b03
        description = unilib.brackets(S("Walkway Platform"), S("Three corner posts")),
        tiles = {platform_img, platform_img, support_img},
        groups = {cracky = 2},
        -- N.B. No sounds in original code
        sounds = unilib.sound_table.metal,
    ...
    unilib.register_craft({
        -- From factory_bridges:b03
        output = "unilib:misc_walkway_platform_4",
        recipe = {
            {"unilib:misc_walkway_support_1", "", "unilib:misc_walkway_support_1"},
            {"", "unilib:misc_walkway_platform_1", ""},
            {"", "", "unilib:misc_walkway_support_1"},
    ...
    unilib.register_craft({
        ...
        output = "unilib:misc_walkway_platform_4",
        recipe = {
            {"", "unilib:misc_walkway_support_3", ""},
            {"", "unilib:misc_walkway_platform_1", ""},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_platform_5", "factory_bridges:b04", mode, {
        -- From factory_bridges:b04
        description = unilib.brackets(S("Walkway Platform"), S("Four corner posts")),
        tiles = {platform_img, platform_img, support_img},
        groups = {cracky = 2},
        -- N.B. No sounds in original code
        sounds = unilib.sound_table.metal,
    ...
    unilib.register_craft({
        -- From factory_bridges:b04
        output = "unilib:misc_walkway_platform_5",
        recipe = {
            {"unilib:misc_walkway_support_1", "", "unilib:misc_walkway_support_1"},
            {"", "unilib:misc_walkway_platform_1", ""},
            {"unilib:misc_walkway_support_1", "", "unilib:misc_walkway_support_1"},
    ...
    unilib.register_craft({
        ...
        output = "unilib:misc_walkway_platform_5",
        recipe = {
            {"", "unilib:misc_walkway_support_4", ""},
            {"", "unilib:misc_walkway_platform_1", ""},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_platform_6", "factory_bridges:b05", mode, {
        -- From factory_bridges:b05
        description = unilib.brackets(S("Walkway Platform"), S("Remote control")),
        tiles = {platform_img, platform_img, support_img},
        groups = {cracky = 2},
        -- N.B. No sounds in original code
        sounds = unilib.sound_table.metal,
    ...
    unilib.register_craft({
        -- From factory_bridges:b05
        output = "unilib:misc_walkway_platform_6",
        recipe = {
            {"", "unilib:misc_walkway_support_5", ""},
            {"", "unilib:misc_walkway_platform_1", ""},
            {"", "", ""},
    ...
    unilib.register_node("unilib:misc_walkway_platform_7", "factory_bridges:b06", mode, {
        -- From factory_bridges:b06
        description = unilib.brackets(
            S("Walkway Platform"), S("Railing and near right-corner post")
        ),
        tiles = {platform_img, platform_img, support_img},
        groups = {cracky = 2},
        -- N.B. No sounds in original code
    ...
    unilib.register_craft({
        -- From factory_bridges:b06
        output = "unilib:misc_walkway_platform_7",
        recipe = {
            {"", "unilib:misc_walkway_support_5", ""},
            {"", "unilib:misc_walkway_platform_1", ""},
            {"", "", "unilib:misc_walkway_support_1"},
    ...
    unilib.register_craft({
        ...
        output = "unilib:misc_walkway_platform_7",
        recipe = {
            {"", "unilib:misc_walkway_support_7", ""},
            {"", "unilib:misc_walkway_platform_1", ""},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_platform_8", "factory_bridges:b07", mode, {
        -- From factory_bridges:b07
        description = unilib.brackets(
            S("Walkway Platform"), S("Far railing and near left-corner post")
        ),
        tiles = {platform_img, platform_img, support_img},
        groups = {cracky = 2},
        -- N.B. No sounds in original code
    ...
    unilib.register_craft({
        -- From factory_bridges:b07
        output = "unilib:misc_walkway_platform_8",
        recipe = {
            {"", "unilib:misc_walkway_support_5", ""},
            {"", "unilib:misc_walkway_platform_1", ""},
            {"unilib:misc_walkway_support_1", "", ""},
    ...
    unilib.register_craft({
        ...
        output = "unilib:misc_walkway_platform_8",
        recipe = {
            {"", "unilib:misc_walkway_support_8", ""},
            {"", "unilib:misc_walkway_platform_1", ""},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_platform_9", "factory_bridges:b08", mode, {
        -- From factory_bridges:b08
        description = unilib.brackets(
            S("Walkway Platform"), S("Far railing and near corner posts")
        ),
        tiles = {platform_img, platform_img, support_img},
        groups = {cracky = 2},
        -- N.B. No sounds in original code
    ...
    unilib.register_craft({
        -- From factory_bridges:b08
        output = "unilib:misc_walkway_platform_9",
        recipe = {
            {"", "unilib:misc_walkway_support_5", ""},
            {"", "unilib:misc_walkway_platform_1", ""},
            {"unilib:misc_walkway_support_1", "", "unilib:misc_walkway_support_1"},
    ...
    unilib.register_craft({
        ...
        output = "unilib:misc_walkway_platform_9",
        recipe = {
            {"", "unilib:misc_walkway_support_9", ""},
            {"", "unilib:misc_walkway_platform_1", ""},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_platform_10", "factory_bridges:b09", mode, {
        -- From factory_bridges:b09
        description = unilib.brackets(S("Walkway Platform"), S("Far and left railings")),
        tiles = {platform_img, platform_img, support_img},
        groups = {cracky = 2},
        -- N.B. No sounds in original code
        sounds = unilib.sound_table.metal,
    ...
    unilib.register_craft({
        -- From factory_bridges:b09
        output = "unilib:misc_walkway_platform_10",
        recipe = {
            {"", "unilib:misc_walkway_support_5", ""},
            {"unilib:misc_walkway_support_5", "unilib:misc_walkway_platform_1", ""},
            {"", "", ""},
        },
    })
    unilib.register_craft({
        ...
        output = "unilib:misc_walkway_platform_10",
        recipe = {
            {"", "unilib:misc_walkway_support_10", ""},
            {"", "unilib:misc_walkway_platform_1", ""},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_platform_11", "factory_bridges:b10", mode, {
        -- From factory_bridges:b10
        description = unilib.brackets(
            S("Walkway Platform"), S("Far and left railings, and near corner-right post")
        ),
        tiles = {platform_img, platform_img, support_img},
        groups = {cracky = 2},
        -- N.B. No sounds in original code
    ...
    unilib.register_craft({
        -- From factory_bridges:b10
        output = "unilib:misc_walkway_platform_11",
        recipe = {
            {"", "unilib:misc_walkway_support_5", ""},
            {"unilib:misc_walkway_support_5", "unilib:misc_walkway_platform_1", ""},
            {"", "", "unilib:misc_walkway_support_1"},
    ...
    unilib.register_craft({
        ...
        output = "unilib:misc_walkway_platform_11",
        recipe = {
            {"", "unilib:misc_walkway_support_11", ""},
            {"", "unilib:misc_walkway_platform_1", ""},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_platform_12", "factory_bridges:b11", mode, {
        -- From factory_bridges:b11
        description = unilib.brackets(S("Walkway Platform"), S("Left and right railings")),
        tiles = {platform_img, platform_img, support_img},
        groups = {cracky = 2},
        -- N.B. No sounds in original code
        sounds = unilib.sound_table.metal,
    ...
    unilib.register_craft({
        -- From factory_bridges:b11
        output = "unilib:misc_walkway_platform_12",
        recipe = {
            {"", "", ""},
            {
                "unilib:misc_walkway_support_5",
    ...
    unilib.register_craft({
        ...
        output = "unilib:misc_walkway_platform_12",
        recipe = {
            {"", "unilib:misc_walkway_support_12", ""},
            {"", "unilib:misc_walkway_platform_1", ""},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_platform_13", "factory_bridges:b12", mode, {
        -- From factory_bridges:b12
        description = unilib.brackets(S("Walkway Platform"), S("Left, right and far railings")),
        tiles = {platform_img, platform_img, support_img},
        groups = {cracky = 2},
        -- N.B. No sounds in original code
        sounds = unilib.sound_table.metal,
    ...
    unilib.register_craft({
        -- From factory_bridges:b12
        output = "unilib:misc_walkway_platform_13",
        recipe = {
            {"", "unilib:misc_walkway_support_5", ""},
            {
                "unilib:misc_walkway_support_5",
    ...
    unilib.register_craft({
        ...
        output = "unilib:misc_walkway_platform_13",
        recipe = {
            {"", "unilib:misc_walkway_support_13", ""},
            {"", "unilib:misc_walkway_platform_1", ""},
            {"", "", ""},
        },
    })
    ...
    unilib.register_node("unilib:misc_walkway_steps_1", "factory_bridges:c00", mode, {
        -- From factory_bridges:c00
        description = unilib.brackets(S("Walkway Steps"), S("Simple")),
    ...
    unilib.register_craft({
        -- From factory_bridges:c00
        output = "unilib:misc_walkway_steps_1 2",
        recipe = {
            {"unilib:misc_walkway_item_beam", "unilib:misc_walkway_platform_1", ""},
            {"unilib:misc_walkway_platform_1", "unilib:misc_walkway_item_beam", ""},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_steps_2", "factory_bridges:c01", mode, {
        -- From factory_bridges:c01
        description = unilib.brackets(S("Walkway Steps"), S("Left handrail")),
        tiles = {steps_img, steps_img, support_img},
        groups = {cracky = 2},
        -- N.B. No sounds in original code
        sounds = unilib.sound_table.metal,
    ...
    unilib.register_craft({
        -- From factory_bridges:c01
        output = "unilib:misc_walkway_steps_2",
        recipe = {
            {"", "", ""},
            {"unilib:misc_walkway_support_14", "unilib:misc_walkway_steps_1", ""},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_steps_3", "factory_bridges:c02", mode, {
        -- From factory_bridges:c02
        description = unilib.brackets(S("Walkway Steps"), S("Right handrail")),
        tiles = {steps_img, steps_img, support_img},
        groups = {cracky = 2},
        -- N.B. No sounds in original code
        sounds = unilib.sound_table.metal,
    ...
    unilib.register_craft({
        -- From factory_bridges:c02
        output = "unilib:misc_walkway_steps_3",
        recipe = {
            {"", "", ""},
            {"", "unilib:misc_walkway_steps_1", "unilib:misc_walkway_support_15"},
            {"", "", ""},
        },
    })

    unilib.register_node("unilib:misc_walkway_steps_4", "factory_bridges:c03", mode, {
        -- From factory_bridges:c03
        description = unilib.brackets(S("Walkway Steps"), S("Dual handrails")),
        tiles = {steps_img, steps_img, support_img},
        groups = {cracky = 2},
        -- N.B. No sounds in original code
        sounds = unilib.sound_table.metal,
    ...
    unilib.register_craft({
        -- From factory_bridges:c03
        output = "unilib:misc_walkway_steps_4",
        recipe = {
            {"", "", ""},
            {
                "unilib:misc_walkway_support_14",
                "unilib:misc_walkway_steps_1",
                "unilib:misc_walkway_support_15",
            },
            {"", "", ""},
        },
    })
    unilib.register_craft({
        ...
        output = "unilib:misc_walkway_steps_4",
        recipe = {
            {"", "unilib:misc_walkway_support_16", ""},
            {"", "unilib:misc_walkway_steps_1", ""},
            {"", "", ""},
        },
    })
    ...
    unilib.register_node("unilib:misc_walkway_hatch_closed", "factory_bridges:d00", mode, {
        -- From factory_bridges:d00
        description = unilib.brackets(S("Walkway Hatch"), S("Closed")),
        ...
        on_rightclick = function(pos, node)
            ...
            minetest.set_node(pos, {name = "unilib:misc_walkway_hatch_open", param2 = node.param2})

        end,
    })
    unilib.register_craft({
        -- From factory_bridges:d00
        output = "unilib:misc_walkway_hatch_closed",
        recipe = {
            {"", "unilib:misc_walkway_item_beam", ""},
            {
                "unilib:misc_walkway_item_beam",
    ...
    unilib.register_node("unilib:misc_walkway_hatch_open", "factory_bridges:d01", mode, {
        -- From factory_bridges:d01
        description = unilib.brackets(S("Walkway Hatch"), S("Open")),
        tiles = {hatch_img},
        ...
        drawtype = "nodebox",
        drop = "unilib:misc_walkway_hatch_closed",
        node_box = {
            type = "fixed",
        ...
        on_rightclick = function(pos, node)
            ...
            minetest.set_node(
                pos, {name = "unilib:misc_walkway_hatch_closed", param2 = node.param2}
            )
    ...
    unilib.register_craftitem("unilib:misc_walkway_item_pole", "factory_bridges:i00", mode, {
        -- From factory_bridges:i00
        description = unilib.brackets(S("Walkway Construction Item"), S("Pole")),
        inventory_image = "unilib_misc_walkway_item_pole.png",
        stack_max = 200,
    })
    unilib.register_craft({
        -- From factory_bridges:i00
        output = "unilib:misc_walkway_item_pole 200",
        recipe = {
    ...
    unilib.register_craftitem("unilib:misc_walkway_item_block", "factory_bridges:i01", mode, {
        -- From factory_bridges:i01
        description = unilib.brackets(S("Walkway Construction Item"), S("Block")),
        inventory_image = "unilib_misc_walkway_item_block.png",
        stack_max = 350,
    })
    unilib.register_craft({
        -- From factory_bridges:i01
        output = "unilib:misc_walkway_item_block 350",
        recipe = {
            {"unilib:metal_steel_ingot", "unilib:metal_steel_ingot", "default:stick"},
        },
    })

    unilib.register_craftitem("unilib:misc_walkway_item_beam", "factory_bridges:i02", mode, {
        -- From factory_bridges:i02
        description = unilib.brackets(S("Walkway Construction Item"), S("Beam")),
        inventory_image = "unilib_misc_walkway_item_beam.png",
    })
    unilib.register_craft({
        -- From factory_bridges:i02
        output = "unilib:misc_walkway_item_beam",
        recipe = {
            {
                "unilib:misc_walkway_item_block",
                "unilib:misc_walkway_item_block",
