...
function unilib.pkg.tree_tawa.exec()
    ...
    unilib.register_leafdecay({
        ...
        leaves = {"unilib:tree_tawa_leaves"},
        others = {"unilib:fruit_tawa"},
        radius = 3,
    })
    ...
    unilib.register_fence_gate_quick({
        -- From aotearoa:gate_tawa_wood_closed, etc. Creates unilib:gate_tawa_closed, etc
        part_name = "tawa",
    ...
    for i = 1, 2 do
        ...
        unilib.register_decoration_generic("aotearoa_tree_tawa_normal_" .. i, {
            -- From aotearoa/spawn_trees.lua
            deco_type = "schematic",
            schematic = unilib.core.path_mod .. "/mts/unilib_tree_tawa_" .. i .. ".mts",
        ...
        unilib.register_decoration_generic("aotearoa_tree_tawa_dense_" .. i, {
            -- From aotearoa/spawn_trees.lua
            deco_type = "schematic",
            schematic = unilib.core.path_mod .. "/mts/unilib_tree_tawa_" .. i .. ".mts",
        ...
        unilib.register_decoration_generic("aotearoa_tree_tawa_rare_" .. i, {
            -- From aotearoa/spawn_trees.lua
            deco_type = "schematic",
            schematic = unilib.core.path_mod .. "/mts/unilib_tree_tawa_" .. i .. ".mts",
