...
function unilib.pkg.tree_kahikatea.exec()
    ...
    unilib.register_fence_gate_quick({
        -- From aotearoa:gate_kahikatea_wood. Creates unilib:gate_kahikatea_closed
        part_name = "kahikatea",
    ...
    for i = 1, 2 do
        ...
        unilib.register_decoration("aotearoa_tree_kahikatea_dense_" .. i, {
            -- From aotearoa/spawn_trees.lua
            deco_type = "schematic",
            schematic = unilib.path_mod .. "/mts/unilib_tree_kahikatea_" .. i .. ".mts",
        ...
        unilib.register_decoration("aotearoa_tree_kahikatea_rare_" .. i, {
            -- From aotearoa/spawn_trees.lua
            deco_type = "schematic",
            schematic = unilib.path_mod .. "/mts/unilib_tree_kahikatea_" .. i .. ".mts",
