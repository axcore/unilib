...
function unilib.pkg.tree_cherry_blossom.exec()
    ...
    unilib.override_item("unilib:tree_cherry_blossom_trunk_stripped", {
        drawtype = "nodebox",
        node_box = node_box,
        paramtype = "light",
        selection_box = node_box,
    ...
    for i = 1, 3 do
        ...
        unilib.register_decoration_generic("glem_tree_cherry_blossom_" .. i, {
            -- Original to unilib
            deco_type = "schematic",
            schematic =
                    unilib.core.path_mod .. "/mts/unilib_glem_tree_cherry_blossom_" .. i .. ".mts",
