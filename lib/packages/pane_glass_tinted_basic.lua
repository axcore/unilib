...
unilib.pkg.pane_glass_tinted_basic = {}
...
function unilib.pkg.pane_glass_tinted_basic.init()

    return {
        description = "Tinted glass pane",
        depends = "glass_tinted_basic",
    }

end

function unilib.pkg.pane_glass_tinted_basic.exec()
