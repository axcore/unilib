...
function unilib.pkg.stone_basalt_black.exec()
    ...
    local smooth_cracky, block_cracky = unilib.get_adjusted_cracky("basalt_black", 2, 2)
    ...
    unilib.set_auto_rotate("unilib:stone_basalt_black_brick", unilib.auto_rotate_brick_flag)
