...
function unilib.pkg.base_minimal.init()

    -- By running this section in .init(), rather than .exec, we can guarantee that it is the first
    --      package code run (assuming that the "minimal" remix lists this package first)
    ...
    return {
        description = "Base package for the minimal remix",
...
function unilib.pkg.base_minimal.post()
