...
function unilib.pkg.machine_lever.init()
...
function unilib.pkg.machine_lever.exec()

    unilib.register_node("unilib:machine_lever_off", "xdecor:lever_off", mode, {
        -- From xdecor:lever_off
        description = S("Door Lever"),
        tiles = {"unilib_machine_lever_off.png"},
        ...
        inventory_image = "unilib_machine_lever_off.png",
    ...
    unilib.register_craft({
        -- From xdecor:lever_off
        output = "unilib:machine_lever_off",
        recipe = {
            {"group:stick"},
            {"group:stone"},
        },
    ...
    if unilib.global.pkg_executed_table["shared_screwdriver"] ~= nil then
        ...
        unilib.override_item("unilib:machine_lever_off", {
            on_rotate = unilib.pkg.shared_screwdriver.rotate_simple,
        })

    end
    -- N.B. This item was renamed in unilib v1.1.0
    core.register_alias("unilib:device_lever_off", "unilib:machine_lever_off")

    unilib.register_node("unilib:machine_lever_on", "xdecor:lever_on", mode, {
        -- From xdecor:lever_on
        -- (no description)
        tiles = {"unilib_machine_lever_on.png"},
        groups = {cracky = 3, not_in_creative_inventory = 1, oddly_breakable_by_hand = 2},
        sounds = unilib.global.sound_table.stone,

        drawtype = "nodebox",
        drop = "unilib:machine_lever_off",
        -- N.B. is_ground_content = false not in original code
        is_ground_content = false,
        node_box = {
            type = "fixed",
    ...
    if unilib.global.pkg_executed_table["shared_screwdriver"] ~= nil then
        ...
        unilib.override_item("unilib:machine_lever_on", {
            on_rotate = unilib.pkg.shared_screwdriver.rotate_simple,
        })

    end
    -- N.B. This item was renamed in unilib v1.1.0
    core.register_alias("unilib:device_lever_on", "unilib:machine_lever_on")
