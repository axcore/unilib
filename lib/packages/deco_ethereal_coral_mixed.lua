...
function unilib.pkg.deco_ethereal_coral_mixed.exec()
    ...
    if unilib.global.pkg_executed_table["biome_ethereal_rainforest"] ~= nil or
            unilib.global.pkg_executed_table["biome_ethereal_savanna"] ~= nil then
        unilib.register_mixed_coral_as_decoration("ethereal_coral_mixed_1")
    end

    if unilib.global.pkg_executed_table["biome_ethereal_grove"] ~= nil then

        unilib.register_decoration_generic("ethereal_coral_mixed_2", {
            -- From ethereal-ng/schems.lua
            deco_type = "schematic",
            schematic = unilib.core.path_mod .. "/mts/unilib_coral_mixed.mts",
...
function unilib.pkg.deco_ethereal_coral_mixed.post()
    ...
    if unilib.global.pkg_executed_table["biome_ethereal_rainforest"] ~= nil or
        ...
        unilib.register_decoration_complete("ethereal_coral_mixed_1", nil, {
    ...
    if unilib.global.pkg_executed_table["biome_ethereal_grove"] ~= nil then
        ...
        unilib.register_decoration_complete("ethereal_coral_mixed_2", nil, {
            -- From ethereal-ng/schems.lua
