...
function unilib.pkg.stone_marble_brown.exec()
    ...
    local smooth_cracky, block_cracky = unilib.get_adjusted_cracky("marble_brown", 3, nil)
    ...
    unilib.set_auto_rotate("unilib:stone_marble_brown_brick", unilib.auto_rotate_brick_flag)
