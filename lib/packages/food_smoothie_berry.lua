...
unilib.pkg.food_smoothie_berry = {}
...
function unilib.pkg.food_smoothie_berry.init()
...
function unilib.pkg.food_smoothie_berry.exec()

    unilib.register_craftitem("unilib:food_smoothie_berry", "farming:smoothie_berry", mode, {
        -- From farming:smoothie_berry
        description = S("Triple Berry Smoothie"),
        inventory_image = "unilib_food_smoothie_berry.png",
        -- N.B. no food_banana in original code
        groups = {drink = 1, food_berry_smoothie = 1, vessel = 1},

        on_use = unilib.cuisine_eat_on_use(
            "unilib:food_smoothie_berry", 6, "unilib:vessel_glass_empty"
        ),
    })
