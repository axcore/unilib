...
function unilib.pkg.metal_ruthenium.exec()
    ...
    unilib.register_stairs("unilib:metal_ruthenium_block")
    unilib.register_carvings("unilib:metal_ruthenium_block", {
        millwork_flag = true,
    })

    if unilib.setting.squeezed_metal_flag then

        unilib.register_node("unilib:metal_ruthenium_block_compressed", nil, mode, {
            -- Original to unilib
            description = S("Compressed Ruthenium Block"),
            tiles = {"unilib_metal_ruthenium_block_compressed.png"},
        ...
        unilib.misc.set_compressed_metal_recipes("ruthenium")
