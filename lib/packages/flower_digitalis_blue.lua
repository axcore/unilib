...
function unilib.pkg.flower_digitalis_blue.init()

    return {
        description = "Blue digitalis",
    }

end

function unilib.pkg.flower_digitalis_blue.exec()
    ...
    unilib.register_node("unilib:flower_digitalis_blue", "herbs:digitalis_blue", mode, {
        ...
        buildable_to = true,
        drawtype = "plantlike",
        inventory_image = "unilib_flower_digitalis_blue.png",
        paramtype = "light",
        selection_box = {
            type = "fixed",
        ...
        walkable = false,
        waving = 1,
        wield_image = "unilib_flower_digitalis_blue.png",
    })
