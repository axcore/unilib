...
unilib.pkg.stone_slimestone_black_extra = {}
...
function unilib.pkg.stone_slimestone_black_extra.init()

    return {
        description = "Creates black slime items, associated with slate (note that there is no" ..
                " \"stone_slimestone_black\" package)",
        depends = {"shared_underch_slime", "stone_slate_red"},
    }

end

function unilib.pkg.stone_slimestone_black_extra.exec()
