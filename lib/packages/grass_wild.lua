...
local function do_decoration(offset, scale, length)
    ...
    unilib.register_decoration("glemr11_grass_wild_" .. length, {
...
function unilib.pkg.grass_wild.exec()
    ...
    -- First variant
    unilib.register_node("unilib:grass_wild_1", "lib_ecology:grass_green_1", mode, {
        ...
        on_place = function(itemstack, placer, pointed_thing)
            ...
            return ItemStack("unilib:grass_wild_1 " ..
    ...
    unilib.register_craft({
        -- Original to unilib
        type = "fuel",
        recipe = "unilib:grass_wild_1",
        burntime = 2,
    })
    unilib.register_plant_in_pot("unilib:grass_wild_1", "lib_ecology:grass_green_1")
