...
function unilib.pkg.biome_ethereal_swamp.init()
    ...
    return {
        ...
        depends = {"clay_ordinary", "dirt_ordinary", "sand_ordinary", "stone_ordinary"},
    }
...
function unilib.pkg.biome_ethereal_swamp.post()
    ...
    unilib.register_biome({
        ...
        name = "ethereal_swamp",
        description = unilib.brackets(S("Swamp biome"), "ethereal"),
    ...
    unilib.register_biome({
        ...
        description = unilib.brackets(S("Swamp ocean biome"), "ethereal"),
