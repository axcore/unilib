...
function unilib.pkg.deco_australia_tree_banksia_bull.init()
    ...
    return {
        ...
        depends = {"biome_australia_jarrah_karri_forests", "dirt_ordinary", "tree_banksia_bull"},
    }
...
function unilib.pkg.deco_australia_tree_banksia_bull.post()
    ...
    for i = 1, 2 do
        ...
        unilib.register_decoration_now("australia_tree_banksia_bull_in_forests_" .. i, nil, {
