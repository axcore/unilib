...
function unilib.pkg.plant_spinifex.exec()
    ...
    unilib.register_node("unilib:plant_spinifex", "australia:spinifex", mode, {
        ...
        description = unilib.utils.annotate(S("Spinifex"), "Triodia longiceps"),
    ...
    unilib.register_decoration_generic("australia_plant_spinifex_1", {
        -- From australia:spinifex
        deco_type = "simple",
    ...
    unilib.register_decoration_generic("australia_plant_spinifex_3", {
        -- From australia:spinifex
        deco_type = "simple",
        decoration = "unilib:plant_spinifex",
