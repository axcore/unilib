...
function unilib.pkg.sand_dacite.exec()
    ...
    if unilib.setting.squeezed_sand_flag then
        ...
        unilib.register_node("unilib:sand_dacite_compressed", nil, mode, {
            -- Original to unilib
            description = S("Compressed Dacite Sand"),
            tiles = {"unilib_sand_dacite_compressed.png"},
        ...
        -- Original to unilib
        unilib.misc.set_squeezed_recipes("unilib:sand_dacite", "unilib:sand_dacite_compressed")
