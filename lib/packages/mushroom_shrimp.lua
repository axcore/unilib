...
function unilib.pkg.mushroom_shrimp.exec()
    ...
    unilib.register_node("unilib:mushroom_shrimp", "nsspf:russula_xerampelina", mode, {
        ...
        description = unilib.annotate(S("Shrimp Mushroom"), "Russula xerampelina"),
        ...
        on_use = unilib.cuisine_eat_on_use("unilib:mushroom_shrimp", -8),
    })
    ...
    unilib.register_node(
        ...
        mode,
        {
            ...
            on_use = unilib.cuisine_eat_on_use("unilib:mushroom_shrimp_cooked", 6),
        }
    )
    ...
    unilib.register_decoration("nsspf_mushroom_shrimp", {
