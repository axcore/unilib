...
function unilib.pkg.flower_rose_black_cluster.exec()
    ...
    unilib.register_node(
        ...
        mode,
        {
            description = unilib.annotate(S("Cluster of Black Roses"), "Rosa"),
...
--          floodable = true,
    ...
    if unilib.pkg_executed_table["flower_rose_black"] ~= nil then

        unilib.register_craft({
            -- Original to unilib
            output = "unilib:flower_rose_black_cluster",
            recipe = {
                {"unilib:flower_rose_black", "unilib:flower_rose_black"},
                {"unilib:flower_rose_black", "unilib:flower_rose_black"},
            },
        })
