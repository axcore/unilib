...
function unilib.pkg.gravel_chalk_pink.exec()
    ...
    if unilib.setting.squeezed_gravel_flag then
        ...
        unilib.register_node("unilib:gravel_chalk_pink_compressed", nil, mode, {
            -- Original to unilib
            description = S("Compressed Pink Chalk Gravel"),
            tiles = {"unilib_gravel_chalk_pink_compressed.png"},
        ...
        unilib.misc.set_squeezed_recipes(
            -- Original to unilib
            "unilib:gravel_chalk_pink", "unilib:gravel_chalk_pink_compressed"
        )
