...
function unilib.pkg.pole_metal_dark.init()
...
function unilib.pkg.pole_metal_dark.exec()

    unilib.register_node("unilib:pole_metal_dark", "morelights:pole_d", mode, {
        ...
        inventory_image = "unilib_pole_metal_dark_inv.png",
        paramtype = "light",
        ...
        wield_image = "unilib_pole_metal_dark_inv.png",
        ...
        on_place = function(itemstack, placer, pointed_thing)
            ...
            return unilib.pkg.shared_morelights.on_place_hanging(
                ...
                placer,
                pointed_thing,
                "unilib:pole_metal_dark_ceiling"
            )
    ...
    unilib.register_craft({
        -- From morelights:pole_d
        output = "unilib:pole_metal_dark 2",
        recipe = {
    ...
    unilib.register_node("unilib:pole_metal_dark_ceiling", "morelights:pole_ceiling_d", mode, {
