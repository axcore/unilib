...
function unilib.pkg.tree_gum_sugar.exec()
    ...
    unilib.register_fence_gate_quick({
        -- Original to unilib. Creates unilib:gate_gum_sugar_closed, etc
        part_name = "gum_sugar",
        orig_name = {nil, nil},
    ...
    for i = 1, 3 do
        ...
        unilib.register_decoration_generic("australia_tree_gum_sugar_in_central_" .. i, {
            -- From australia/biome_central_australia.lua
            deco_type = "schematic",
            schematic = unilib.core.path_mod .. "/mts/unilib_tree_gum_sugar_" .. i .. ".mts",
    ...
    for i = 1, 3 do
        ...
        unilib.register_decoration_generic("australia_tree_gum_sugar_in_flinders_" .. i, {
