...
function unilib.pkg.flower_dandelion_white_cluster.exec()
    ...
    unilib.register_node(
        ...
        mode,
        {
            description = unilib.utils.annotate(S("Cluster of White Dandelions"), "Taraxacum"),
...
--          is_ground_content = false,
    ...
    if unilib.global.pkg_executed_table["flower_dandelion_white"] ~= nil then
    ...
    unilib.register_decoration_spare("unilib:flower_dandelion_white_cluster")
