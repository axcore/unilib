...
function unilib.pkg.metal_germanium.exec()
    ...
    unilib.register_stairs("unilib:metal_germanium_block")
    unilib.register_carvings("unilib:metal_germanium_block", {
        millwork_flag = true,
    })

    if unilib.setting.squeezed_metal_flag then

        unilib.register_node("unilib:metal_germanium_block_compressed", nil, mode, {
            -- Original to unilib
            description = S("Compressed Germanium Block"),
            tiles = {"unilib_metal_germanium_block_compressed.png"},
        ...
        unilib.misc.set_compressed_metal_recipes("germanium")
