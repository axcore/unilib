...
function unilib.pkg.sand_greywacke_pale.exec()
    ...
    if unilib.setting.squeezed_sand_flag then
        ...
        unilib.register_node("unilib:sand_greywacke_pale_compressed", nil, mode, {
            -- Original to unilib
            description = S("Compressed Pale Greywacke Sand"),
            tiles = {"unilib_sand_greywacke_pale_compressed.png"},
        ...
        unilib.misc.set_squeezed_recipes(
            -- Original to unilib
            "unilib:sand_greywacke_pale", "unilib:sand_greywacke_pale_compressed"
        )
