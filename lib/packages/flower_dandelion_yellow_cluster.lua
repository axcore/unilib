...
function unilib.pkg.flower_dandelion_yellow_cluster.exec()
    ...
    unilib.register_node(
        ...
        mode,
        {
            description = unilib.utils.annotate(S("Cluster of Yellow Dandelions"), "Taraxacum"),
...
--          is_ground_content = false,
    ...
    if unilib.global.pkg_executed_table["flower_dandelion_yellow"] ~= nil then

        unilib.register_craft_2x2({
            -- Original to unilib
            output = "unilib:flower_dandelion_yellow_cluster",
            ingredient = "unilib:flower_dandelion_yellow",
        })
    ...
    unilib.register_decoration_spare("unilib:flower_dandelion_yellow_cluster")
