...
function unilib.pkg.tree_totara.exec()
    ...
    unilib.register_fence_gate_quick({
        -- From aotearoa:gate_totara_wood. Creates unilib:gate_totara_closed
        part_name = "totara",
    ...
    for i = 1, 2 do
        ...
        unilib.register_decoration("aotearoa_tree_totara_rare_" .. i, {
            -- From aotearoa/spawn_trees.lua
            deco_type = "schematic",
            schematic = unilib.path_mod .. "/mts/unilib_tree_totara_" .. i .. ".mts",
        ...
        unilib.register_decoration("aotearoa_tree_totara_dense_" .. i, {
            -- From aotearoa/spawn_trees.lua
            deco_type = "schematic",
            schematic = unilib.path_mod .. "/mts/unilib_tree_totara_" .. i .. ".mts",
