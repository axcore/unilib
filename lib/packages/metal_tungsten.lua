...
function unilib.pkg.metal_tungsten.exec()
    ...
    unilib.register_stairs("unilib:metal_tungsten_block")
    unilib.register_carvings("unilib:metal_tungsten_block", {
        millwork_flag = true,
    })

    if unilib.setting.squeezed_metal_flag then

        unilib.register_node("unilib:metal_tungsten_block_compressed", nil, mode, {
            -- Original to unilib
            description = S("Compressed Tungsten Block"),
            tiles = {"unilib_metal_tungsten_block_compressed.png"},
        ...
        unilib.misc.set_compressed_metal_recipes("tungsten")
