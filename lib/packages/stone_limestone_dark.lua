...
function unilib.pkg.stone_limestone_dark.exec()
    ...
    unilib.register_stone_rubble_compressed({
        -- Original to unilib. Creates unilib:stone_limestone_dark_rubble_compressed
        part_name = "limestone_dark",
        orig_name = nil,

        replace_mode = mode,
        description = S("Compressed Dark Limestone Rubble"),
    })

    unilib.register_stone_rubble_condensed({
        -- Original to unilib. Creates unilib:stone_limestone_dark_rubble_condensed
        part_name = "limestone_dark",
        orig_name = nil,

        replace_mode = mode,
        description = S("Condensed Dark Limestone Rubble"),
    })
