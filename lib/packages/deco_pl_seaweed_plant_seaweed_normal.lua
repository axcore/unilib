...
function unilib.pkg.deco_pl_seaweed_plant_seaweed_normal.post()
    ...
    --[[
    unilib.register_decoration_complete("convert_plant_seaweed_normal_above_dirt", nil, {
    ...
    --[[
    unilib.register_decoration_complete("convert_plant_seaweed_normal_above_sand", nil, {
        -- From pl_seaweed/init.lua
        -- Completes decoration in package "plant_seaweed_normal"
        place_on = "unilib:liquid_water_ordinary_source",
    ...
    unilib.register_decoration_complete("convert_plant_seaweed_normal_on_sand", nil, {
        -- From pl_seaweed/init.lua
        -- Completes decoration in package "plant_seaweed_normal"
        place_on = "unilib:sand_ordinary",
