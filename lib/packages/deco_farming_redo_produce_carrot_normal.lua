...
function unilib.pkg.deco_farming_redo_produce_carrot_normal.init()
    ...
    return {
        ...
        depends = "produce_carrot_normal",
        at_least_one = {"dirt_ordinary", "dirt_ordinary_with_turf_prairie"},
    }

end

function unilib.pkg.deco_farming_redo_produce_carrot_normal.post()

    unilib.register_decoration_complete("farming_redo_produce_carrot_normal", nil, {
