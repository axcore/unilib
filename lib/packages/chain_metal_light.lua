...
function unilib.pkg.chain_metal_light.init()
...
function unilib.pkg.chain_metal_light.exec()

    unilib.register_node("unilib:chain_metal_light", "morelights:chain_l", mode, {
        ...
        drawtype = "mesh",
        inventory_image = "unilib_chain_metal_light_inv.png",
        ...
        wield_image = "unilib_chain_metal_light_inv.png",
        ...
        on_place = function(itemstack, placer, pointed_thing)
            ...
            return unilib.pkg.shared_morelights.on_place_hanging(
                ...
                placer,
                pointed_thing,
                "unilib:chain_metal_light_ceiling"
            )
    ...
    unilib.register_craft({
        -- From morelights:chain_l
        output = "unilib:chain_metal_light",
        recipe = {
    ...
    unilib.register_node("unilib:chain_metal_light_ceiling", "morelights:chain_ceiling_l", mode, {
