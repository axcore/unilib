...
--      offset_list = {2, 1, 2},
    ...
    unilib.register_fence_gate_quick({
        -- From birch:gate. Creates unilib:gate_birch_mature_closed
        part_name = "birch_mature",
    ...
    unilib.register_decoration("cool_trees_tree_birch_mature", {
        -- From birch/init.lua
        deco_type = "schematic",
        schematic = unilib.path_mod .. "/mts/unilib_tree_birch_mature.mts",
