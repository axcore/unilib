...
function unilib.pkg.tree_pahautea.exec()
    ...
    unilib.register_fence_gate_quick({
        -- From aotearoa:gate_pahautea_wood_closed, etc. Creates unilib:gate_pahautea_closed, etc
        part_name = "pahautea",
    ...
    for i = 1, 2 do
        ...
        unilib.register_decoration_generic("aotearoa_tree_pahautea_dense_" .. i, {
            -- From aotearoa/spawn_trees.lua
            deco_type = "schematic",
            schematic = unilib.core.path_mod .. "/mts/unilib_tree_pahautea_" .. i .. ".mts",
