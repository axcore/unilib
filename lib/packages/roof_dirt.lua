...
local function do_register(data_table)
    ...
    unilib.register_node(full_name, orig_name, replace_mode, {
        description = unilib.utils.brackets(S("Dirt Roofing"), description),
        tiles = {
...
function unilib.pkg.roof_dirt.post()
    ...
    local orig_name_table = {
        acacia = "earthbuild:acacia_wood_supported_rammed_earth",
        apple = "earthbuild:supported_rammed_earth",
        aspen = "earthbuild:aspen_wood_supported_rammed_earth",
        jungle = "earthbuild:junglewood_supported_rammed_earth",
        pine = "earthbuild:pine_wood_supported_rammed_earth",
    }
