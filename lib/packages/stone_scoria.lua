...
function unilib.pkg.stone_scoria.exec()
    ...
    local smooth_cracky, block_cracky = unilib.stone.get_adjusted_cracky("scoria", 3, 2)
    ...
    unilib.utils.set_auto_rotate("unilib:stone_scoria_brick", unilib.setting.auto_rotate_brick_flag)
    ...
    unilib.register_stone_cobble_or_rubble_or_nothing({
        ...
        cobble_compressed_description = S("Compressed Scoria Cobble"),
        cobble_condensed_description = S("Condensed Scoria Cobble"),
        rubble_description = S("Scoria Rubble"),
        rubble_compressed_description = S("Compressed Scoria Rubble"),
        rubble_condensed_description = S("Condensed Scoria Rubble"),
        smooth_compressed_description = S("Compressed Scoria"),
        smooth_condensed_description = S("Condensed Scoria"),

        replace_mode = mode,
        override_drop_flag = true,
    })

    unilib.register_decoration_generic("aotearoa_stone_scoria", {
