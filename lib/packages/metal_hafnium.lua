...
function unilib.pkg.metal_hafnium.exec()
    ...
    unilib.register_stairs("unilib:metal_hafnium_block")
    unilib.register_carvings("unilib:metal_hafnium_block", {
        millwork_flag = true,
    })

    if unilib.setting.squeezed_metal_flag then

        unilib.register_node("unilib:metal_hafnium_block_compressed", nil, mode, {
            -- Original to unilib
            description = S("Compressed Hafnium Block"),
            tiles = {"unilib_metal_hafnium_block_compressed.png"},
        ...
        unilib.misc.set_compressed_metal_recipes("hafnium")
