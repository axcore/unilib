...
unilib.pkg.abm_standard_leaves_falling = {}
...
function unilib.pkg.abm_standard_leaves_falling.init()

    return {
        description = "ABM to handle falling leaves particles (from ethereal-ng)",
    }

end

function unilib.pkg.abm_standard_leaves_falling.post()

    unilib.register_abm({
        label = "Falling leaves particles [abm_standard_leaves_falling]",
