...
function unilib.pkg.stone_brownstone_dark.exec()
    ...
    unilib.register_stone_rubble_compressed({
        -- Original to unilib. Creates unilib:stone_brownstone_dark_rubble_compressed
        part_name = "brownstone_dark",
        orig_name = nil,

        replace_mode = mode,
        description = S("Compressed Dark Brownstone Rubble"),
    })

    unilib.register_stone_rubble_condensed({
        -- Original to unilib. Creates unilib:stone_brownstone_dark_rubble_condensed
        part_name = "brownstone_dark",
        orig_name = nil,

        replace_mode = mode,
        description = S("Condensed Dark Brownstone Rubble"),
    })
