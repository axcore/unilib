...
function unilib.pkg.gravel_siltstone_pale.exec()
    ...
    if unilib.setting.squeezed_gravel_flag then
        ...
        unilib.register_node("unilib:gravel_siltstone_pale_compressed", nil, mode, {
            -- Original to unilib
            description = S("Compressed Pale Siltstone Gravel"),
            tiles = {"unilib_gravel_siltstone_pale_compressed.png"},
        ...
        unilib.misc.set_squeezed_recipes(
            -- Original to unilib
            "unilib:gravel_siltstone_pale", "unilib:gravel_siltstone_pale_compressed"
        )
