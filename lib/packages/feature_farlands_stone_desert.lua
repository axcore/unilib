...
function unilib.pkg.feature_farlands_stone_desert.exec()
    ...
    for i = 1, 5 do
        ...
        unilib.register_decoration_generic("farlands_feature_stone_desert_" .. i, {
            -- From farlands, mapgen/mapgen.lua
            deco_type = "schematic",
            schematic = unilib.core.path_mod .. "/mts/unilib_feature_stone_desert_" .. i .. ".mts",
...
function unilib.pkg.feature_farlands_stone_desert.post()
    ...
    for i = 1, 5 do
        ...
        unilib.register_decoration_complete("farlands_feature_stone_desert_" .. i, nil, {
            -- From farlands, mapgen/mapgen.lua
