...
function unilib.pkg.shared_bakedclay.register_baked_clay(data_table)
    ...
    unilib.global.clay_baked_table[part_name] = translated_name
...
function unilib.pkg.shared_bakedclay.init()

    return {
        description = "Shared functions for baked clays (from bakedclay)",
    }
