...
function unilib.pkg.stone_limestone_beige.exec()
    ...
    unilib.register_stone_rubble_compressed({
        -- Original to unilib. Creates unilib:stone_limestone_beige_rubble_compressed
        part_name = "limestone_beige",
        orig_name = nil,

        replace_mode = mode,
        description = S("Compressed Beige Limestone Rubble"),
    })

    unilib.register_stone_rubble_condensed({
        -- Original to unilib. Creates unilib:stone_limestone_beige_rubble_condensed
        part_name = "limestone_beige",
        orig_name = nil,

        replace_mode = mode,
        description = S("Condensed Beige Limestone Rubble"),
    })
