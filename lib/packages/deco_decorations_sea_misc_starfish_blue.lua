...
function unilib.pkg.deco_decorations_sea_misc_starfish_blue.init()

    return {
        description = "Blue starfish as decoration",
        depends = {"liquid_water_ordinary", "misc_starfish_blue", "sand_ordinary"},
    }
