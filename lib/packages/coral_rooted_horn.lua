...
function unilib.pkg.coral_rooted_horn.init()
    ...
    return {
        ...
        depends = {"coral_block_horn", "liquid_water_ordinary", "shared_xocean"},
    }
...
function unilib.pkg.coral_rooted_horn.exec()
    ...
    unilib.register_node("unilib:coral_rooted_horn", "xocean:horn", mode, {
        ...
        after_destruct = function(pos, oldnode)
            minetest.set_node(pos, {name = "unilib:coral_block_horn"})
        end,
    ...
    unilib.register_node("unilib:coral_rooted_horn_skeleton", "xocean:skeleton_horn", mode, {
        ...
        after_destruct = function(pos, oldnode)
            minetest.set_node(pos, {name = "unilib:coral_block_horn_skeleton"})
        end,

        on_place = on_place_skeleton,
    })

    unilib.register_decoration("xocean_coral_rooted_horn", {
    ...
    unilib.register_decoration("xocean_coral_rooted_horn_skeleton", {
        -- From xocean/init.lua
        deco_type = "simple",
