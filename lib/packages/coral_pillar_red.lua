...
function unilib.pkg.coral_pillar_red.init()

    return {
        description = "Red coral pillar",
...
function unilib.pkg.coral_pillar_red.exec()

    unilib.register_node("unilib:coral_pillar_red", nil, mode, {
        -- Original to unilib, adapted from lib_ecology:plant_coral_pillar
        description = S("Red Coral Pillar"),
        tiles = {"unilib_coral_pillar_red.png"},
