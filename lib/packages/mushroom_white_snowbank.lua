...
function unilib.pkg.mushroom_white_snowbank.exec()
    ...
    unilib.register_node("unilib:mushroom_white_snowbank", "nsspf:clitocybe_glacialis", mode, {
        ...
        description = unilib.annotate(S("White Snowbank Mushroom"), "Clitocybe glacialis"),
        ...
        on_use = unilib.cuisine_eat_on_use("unilib:mushroom_white_snowbank", 1),
    })
    ...
    unilib.register_node(
        ...
        mode,
        {
            ...
            on_use = unilib.cuisine_eat_on_use("unilib:mushroom_white_snowbank_cooked", 10),
        }
    )
    ...
    unilib.register_decoration("nsspf_mushroom_white_snowbank", {
