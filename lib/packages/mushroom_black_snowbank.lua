...
function unilib.pkg.mushroom_black_snowbank.exec()
    ...
    unilib.register_node("unilib:mushroom_black_snowbank", "nsspf:plectania_nannfeldtii", mode, {
        ...
        description = unilib.utils.annotate(S("Black Snowbank Mushroom"), "Plectania nannfeldtii"),
        ...
        on_use = unilib.cuisine.eat_on_use("unilib:mushroom_black_snowbank", -20),
    })
    ...
    unilib.register_node(
        ...
        mode,
        {
            ...
            on_use = unilib.cuisine.eat_on_use("unilib:mushroom_black_snowbank_cooked", -20),
        }
    )
    ...
    unilib.register_decoration_generic("nsspf_mushroom_black_snowbank", {
