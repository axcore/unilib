...
function unilib.pkg.stone_sandstone_siltstone_pale.exec()
    ...
    if unilib.setting.sandstone_cobble_rubble_flag then
        ...
        unilib.register_stone_cobble_compressed({
            -- Original to unilib. Creates unilib:stone_sandstone_siltstone_pale_cobble_compressed
            part_name = "sandstone_siltstone_pale",
            orig_name = nil,

            replace_mode = mode,
            description = S("Compressed Pale Siltstone Sandstone Cobble"),
        })

        unilib.register_stone_cobble_condensed({
            -- Original to unilib. Creates unilib:stone_sandstone_siltstone_pale_cobble_condensed
            part_name = "sandstone_siltstone_pale",
            orig_name = nil,

            replace_mode = mode,
            description = S("Condensed Pale Siltstone Sandstone Cobble"),
        })
