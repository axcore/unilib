...
function unilib.pkg.mineral_bismuthinite_rock.init()

    return {
        description = "Bismuthinite rock (as mineral)",
        notes = "An alternative to the stone ores with bismuthinite",
...
function unilib.pkg.mineral_bismuthinite_rock.exec()
    ...
    unilib.register_node("unilib:mineral_bismuthinite_rock", nil, mode, {
        -- Texture from AATO, bismuthinite.png. Original code
        ...
        drop = {
            max_items = 1,
            items = {
                {items = {"unilib:mineral_bismuthinite_rock"}, rarity = (100 * hardness)},
