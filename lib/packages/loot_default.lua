...
function unilib.pkg.loot_default.init()
    ...
    return {
        ...
        notes = "Very few mods (besides those in minetest_game) provide dungeon_loot; therefore," ..
                ...
                " their own packages, modelled after this one",
        -- Registers default stuff as dungeon loot, if available
...
function unilib.pkg.loot_default.post()
    ...
    -- Register default stuff as dungeon loot, if available
    if minetest.global_exists("dungeon_loot") then
        ...
        if unilib.pkg_executed_table["fruit_apple"] ~= nil then
        ...
        if unilib.pkg_executed_table["tool_axe_diamond"] ~= nil then
        ...
        if unilib.pkg_executed_table["tool_pick_stone"] ~= nil then
        ...
        if unilib.pkg_executed_table["tool_sword_wood"] ~= nil then
