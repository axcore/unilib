...
function unilib.pkg.sand_rhyolite_dark.exec()
    ...
    if unilib.setting.squeezed_sand_flag then
        ...
        unilib.register_node("unilib:sand_rhyolite_dark_compressed", nil, mode, {
            -- Original to unilib
            description = S("Compressed Dark Rhyolite Sand"),
            tiles = {"unilib_sand_rhyolite_dark_compressed.png"},
        ...
        unilib.misc.set_squeezed_recipes(
            -- Original to unilib
            "unilib:sand_rhyolite_dark", "unilib:sand_rhyolite_dark_compressed"
        )
