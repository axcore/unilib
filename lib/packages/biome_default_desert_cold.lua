...
function unilib.pkg.biome_default_desert_cold.post()
    ...
    unilib.register_biome({
        ...
        description = unilib.utils.brackets(S("Cold desert biome"), "default"),
    ...
    unilib.register_biome({
        ...
        description = unilib.utils.brackets(S("Cold desert ocean biome"), "default"),
    ...
    unilib.register_biome({
        ...
        description = unilib.utils.brackets(S("Cold desert deep ocean biome"), "default"),
        node_cave_liquid = {
