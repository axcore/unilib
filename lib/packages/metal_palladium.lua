...
function unilib.pkg.metal_palladium.exec()
    ...
    unilib.register_stairs("unilib:metal_palladium_block")
    unilib.register_carvings("unilib:metal_palladium_block", {
        millwork_flag = true,
    })

    if unilib.setting.squeezed_metal_flag then

        unilib.register_node("unilib:metal_palladium_block_compressed", nil, mode, {
            -- Original to unilib
            description = S("Compressed Palladium Block"),
            tiles = {"unilib_metal_palladium_block_compressed.png"},
        ...
        unilib.misc.set_compressed_metal_recipes("palladium")
