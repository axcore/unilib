...
function unilib.pkg.stone_schist_brown.exec()
    ...
    unilib.register_stone_cobble_compressed({
        -- Original to unilib. Creates unilib:stone_schist_brown_cobble_compressed
        part_name = "schist_brown",
        orig_name = nil,

        replace_mode = mode,
        description = S("Compressed Brown Schist Cobble"),
    })

    unilib.register_stone_cobble_condensed({
        -- Original to unilib. Creates unilib:stone_schist_brown_cobble_condensed
        part_name = "schist_brown",
        orig_name = nil,

        replace_mode = mode,
        description = S("Condensed Brown Schist Cobble"),
    })
