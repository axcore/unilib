...
function unilib.pkg.mushroom_veiled.exec()
    ...
    if unilib.pkg_executed_table["shared_cropocalypse_mushroom"] ~= nil and
            unilib.pkg_executed_table["stone_ordinary_with_tin"] ~= nil then
    ...
    unilib.register_node("unilib:mushroom_veiled", "cropocalypse:veiled_mushroom", mode, {
        ...
        on_use = unilib.cuisine_eat_on_use("unilib:mushroom_veiled", 4),
    })
    unilib.register_mushroom_in_pot("unilib:mushroom_veiled", "cropocalypse:veiled_mushroom")

    unilib.register_decoration("cropocalypse_mushroom_veiled", {
