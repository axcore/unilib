...
local cache_table = {}
-- Minetest v5.4.1 crashes on game start if cache_table (at the minetest.find_nodes_in_area() call
...
local function update_sound(player)
    ...
    local pos = minetest.find_nodes_in_area(areamin, areamax, cache_table, true)
