...
---------------------------------------------------------------------------------------------------
-- Register juice types
---------------------------------------------------------------------------------------------------

function unilib.register_juice(data_table)

    -- Original to unilib
    -- Registers a juice type
    -- Juices are squeezed from fruits in the press defined by the "machine_press_fruit" package,
    ...
    --      juice_type (str): e.g. "apple"
    --      rgb (str): e.g. "#ecff56"
    --
    -- data_table optional fields:
    --      health (int): e.g. 2 (the number of health points, when the user drinks the juice).
    --          Note the original "drinks" mod used a default value of 1
    ...
    if unilib.generic_juice_table[juice_type] == nil then

        unilib.generic_juice_table[juice_type] = {
        ...
        table.insert(unilib.generic_juice_table[juice_type]["ingredient_list"], ingredient)

    end

end

function unilib.register_juice_duplicate(juice_type, ingredient)
