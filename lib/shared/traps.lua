...
function unilib.register_stone_trap(data_table)
    ...
    if def_table == nil or unilib.pkg_executed_table["mineral_mese"] == nil then
        return
    end
    ...
    unilib.register_node(full_name, orig_name, replace_mode, {
        ...
        description = unilib.brackets(def_table.description, S("Trap")),
...
function unilib.register_glass_trap(data_table)
