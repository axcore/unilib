    ...
    if minetest.is_protected(pos_under, player_name) or
        ...
        unilib.log(
            ...
            player_name .. " tried to place " .. itemstack:get_name() ..
                    " at protected position " .. minetest.pos_to_string(pos_under)
        )
...
function unilib.register_block_coral(data_table)
...
function unilib.register_rooted_coral(data_table)
...
function unilib.register_mixed_coral_as_decoration(generic_deco_name)
    ...
    unilib.register_decoration(generic_deco_name, {
