...
function unilib.liquids._get_empty_container(full_name)
    ...
    -- If it's not a unilib bucket (such as one from unimobs, mobs_animal or petz mods), just return
    --      an empty steel bucket or an empty bottle, assuming that it was the original ingredient
