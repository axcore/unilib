...
function unilib.pbiome_get_pressure(h, r)
...
function unilib.pbiome_get_biome(darkness, water, pressure)
...
function unilib.pbiome_replace(vi, data, def1, def2)
...
function unilib.pbiome_ore(vi, data, def1, def2, chance)
...
function unilib.pbiome_on_floor(x, y, z, vi, area, data, def_floor, def1, def2, chance, alt)
    ...
    if (data[bi] == def_floor or data[bi] == alt)
            and data[vi] == def1 and math.random() < chance then
        data[vi] = def2
    end

end

function unilib.pbiome_in_floor(x, y, z, vi, area, data, def_floor, def1, def2, chance, alt)
    ...
    if (data[vi] == def_floor or data[vi] == alt) and
            data[bi] == def1 and math.random() < chance then
        data[vi] = def2
    end

end

function unilib.pbiome_on_floor_rr(
    ...
    if (data[bi] == def_floor or data[bi] == alt) and
            data[vi] == def1 and math.random() < chance then
...
function unilib.pbiome_on_roof(
    ...
    if (not lastlayer) and
            (data[bi] == def_roof or data[bi] == alt)
            and data[vi] == def1 and math.random() < chance then
        data[vi] = def2
    end
...
function unilib.pbiome_in_roof(
...
function unilib.pbiome_on_wall_f(
...
function unilib.pbiome_on_wall_w(
    x, y, z, vi, area, data, p2data, def_wall, def1, def2, chance, lastlayer, alt
)
...
function unilib.pbiome_setup(biome_table)
            ...
            for y = y0, y1 do
                ...
                for x = x0, x1 do
                    ...
                    if (biome < 1) or (biome > #biome_table) then
                        ...
                        unilib.show_warning(
                            "../lib/shared/pbiomes.lua: Invalid pseudo-biome", biome
                        )
