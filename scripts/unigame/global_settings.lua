...
unilib.setting.show_startup_msg_flag = core.settings:get_bool("unilib_show_startup_msg_flag", false)
...
unilib.setting.init_remix_pkg_set = core.settings:get("unilib_init_remix_pkg_set") or "playme"
...
unilib.setting.mtgame_tweak_flag = core.settings:get_bool("unilib_mtgame_tweak_flag", true)
...
unilib.setting.earthbuild_extend_cutter_flag =
        core.settings:get_bool("unilib_earthbuild_extend_cutter_flag", true)
...
unilib.setting.fachwerk_all_frames_flag =
        core.settings:get_bool("unilib_fachwerk_all_frames_flag", true)
...
unilib.setting.fachwerk_extra_nodes_flag =
        core.settings:get_bool("unilib_fachwerk_extra_nodes_flag", true)
...
unilib.setting.flowerpot_add_mushrooms_flag =
        core.settings:get_bool("unilib_flowerpot_add_mushrooms_flag", true)
...
unilib.setting.flowerpot_add_plants_flag =
        core.settings:get_bool("unilib_flowerpot_add_plants_flag", true)
...
unilib.setting.flowerpot_add_saplings_flag =
        core.settings:get_bool("unilib_flowerpot_add_saplings_flag", true)
...
unilib.setting.moreblocks_hidden_trap_flag =
        core.settings:get_bool("unilib_moreblocks_hidden_trap_flag", true)
...
unilib.setting.plantlife_poison_ivy_poison_flag =
        core.settings:get_bool("unilib_plantlife_poison_ivy_poison_flag", true)
...
unilib.setting.toolranks_enable_flag = core.settings:get_bool("unilib_toolranks_enable_flag", true)
...
unilib.setting.trash_can_throw_flag = core.settings:get_bool("unilib_trash_can_throw_flag", true)
...
unilib.setting.underch_tweak_flag = core.settings:get_bool("unilib_underch_tweak_flag", true)
...
unilib.setting.underch_override_abm_flag =
        core.settings:get_bool("unilib_underch_override_abm_flag", true)
...
unilib.setting.random_seed_offset_flag =
        core.settings:get_bool("unilib_random_seed_offset_flag", true)
...
unilib.setting.mapgen_seed_offset_flag =
        core.settings:get_bool("unilib_mapgen_seed_offset_flag", true)
...
unilib.setting.squeezed_stone_flag = core.settings:get_bool("unilib_squeezed_stone_flag", true)
...
unilib.setting.squeezed_gravel_flag = core.settings:get_bool("unilib_squeezed_gravel_flag", true)
...
unilib.setting.squeezed_dirt_flag = core.settings:get_bool("unilib_squeezed_dirt_flag", true)
...
unilib.setting.squeezed_sand_flag = core.settings:get_bool("unilib_squeezed_sand_flag", true)
...
unilib.setting.squeezed_metal_flag = core.settings:get_bool("unilib_squeezed_metal_flag", true)
...
unilib.setting.squeezed_leaves_flag = core.settings:get_bool("unilib_squeezed_leaves_flag", true)
...
unilib.setting.squeezed_overstack_flag =
        core.settings:get_bool("unilib_squeezed_overstack_flag", true)
...
unilib.setting.real_stone_hardness_flag =
        core.settings:get_bool("unilib_real_stone_hardness_flag", true)
...
unilib.setting.sandstone_cobble_rubble_flag =
        core.settings:get_bool("unilib_sandstone_cobble_rubble_flag", true)
...
unilib.setting.unfussy_turf_flag = core.settings:get_bool("unilib_unfussy_turf_flag", true)
...
unilib.setting.disable_grass_drop_flag =
        core.settings:get_bool("unilib_disable_grass_drop_flag", true)
...
unilib.setting.weak_slim_tree_flag = core.settings:get_bool("unilib_weak_slim_tree_flag", true)
...
unilib.setting.auto_rotate_wood_flag = core.settings:get_bool("unilib_auto_rotate_wood_flag", true)
...
unilib.setting.reduced_wood_flag = core.settings:get_bool("unilib_reduced_wood_flag", true)
...
unilib.setting.regrow_fruit_flag = core.settings:get_bool("unilib_regrow_fruit_flag", true)
...
unilib.setting.leaves_drop_sticks_flag =
        core.settings:get_bool("unilib_leaves_drop_sticks_flag", true)
...
unilib.setting.sapling_variable_grow_flag =
        core.settings:get_bool("unilib_sapling_variable_grow_flag", true)
...
unilib.setting.floodable_flora_flag = core.settings:get_bool("unilib_floodable_flora_flag", true)
...
unilib.setting.flushable_flora_flag = core.settings:get_bool("unilib_flushable_flora_flag", true)
...
unilib.setting.auto_rotate_brick_flag =
        core.settings:get_bool("unilib_auto_rotate_brick_flag", true)
...
unilib.setting.add_stairs_stairs_redo_flag =
        core.settings:get_bool("unilib_add_stairs_stairs_redo_flag", true)
...
unilib.setting.add_carvings_facade_flag =
        core.settings:get_bool("unilib_add_carvings_facade_flag", true)
...
unilib.setting.add_carvings_millwork_flag =
        core.settings:get_bool("unilib_add_carvings_millwork_flag", true)
...
unilib.setting.add_carvings_farlands_flag =
        core.settings:get_bool("unilib_add_carvings_farlands_flag", true)
...
unilib.setting.builtin_entity_effects_flag =
        core.settings:get_bool("unilib_builtin_entity_effects_flag", true)
...
unilib.setting.tool_limit_repair_factor =
        unilib.utils.settings_get_float("unilib_tool_limit_repair_factor") or 0.1
...
unilib.setting.wield_light_flag = core.settings:get_bool("unilib_wield_light_flag", true)
...
unilib.setting.magnet_auto_get_flag = core.settings:get_bool("unilib_magnet_auto_get_flag", true)
...
unilib.setting.magnet_auto_drop_flag = core.settings:get_bool("unilib_magnet_auto_drop_flag", true)
...
unilib.setting.cuisine_advanced_flag = core.settings:get_bool("unilib_cuisine_advanced_flag", true)
...
unilib.setting.hunger_enable_flag = core.settings:get_bool("unilib_hunger_enable_flag", true)
...
unilib.setting.hunger_factor = unilib.utils.settings_get_float("unilib_hunger_factor") or 0.66
...
unilib.setting.thirst_enable_flag = core.settings:get_bool("unilib_thirst_enable_flag", true)
...
unilib.setting.thirst_factor = unilib.utils.settings_get_float("unilib_thirst_factor") or 0.66
...
unilib.setting.stats_bio_flag = core.settings:get_bool("unilib_stats_bio_flag", true)
...
unilib.setting.stats_activity_flag = core.settings:get_bool("unilib_stats_activity_flag", true)
